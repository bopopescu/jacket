...
class ContextTestCase(test.NoDBTestCase):
    ...
    def test_extra_args_to_context_get_logged(self):
        ...
        self.stub_out('compute.context.LOG.warning', fake_warn)
    ...
    def test_service_catalog_cinder_only(self):
        service_catalog = [
                {u'type': u'compute', u'name': u'compute'},
    ...
    def test_to_dict_from_dict_no_log(self):
        ...
        self.stub_out('compute.context.LOG.warn', stub_warn)
    ...
    @mock.patch('compute.db.create_context_manager')
    def test_target_cell(self, mock_create_ctxt_mgr):
        ...
        mapping = compute.CellMapping(database_connection='fake://')

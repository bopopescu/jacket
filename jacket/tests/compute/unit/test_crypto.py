...
class X509Test(test.NoDBTestCase):
    @mock.patch('compute.db.certificate_create')
...
class RevokeCertsTest(test.NoDBTestCase):
    ...
    @mock.patch('compute.crypto.revoke_cert')
    def test_revoke_certs_by_user_and_project(self, mock_revoke):
        ...
        self.stub_out('compute.db.certificate_get_all_by_user_and_project',
    ...
    def test_revoke_certs_by_user(self, mock_revoke):
        ...
        self.stub_out('compute.db.certificate_get_all_by_user',
    ...
    def test_revoke_certs_by_project(self, mock_revoke):
        ...
        self.stub_out('compute.db.certificate_get_all_by_project',

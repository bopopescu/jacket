...
from jacket.tests.compute.unit import utils as tests_utils
...
class VirtDiskVFSLocalFSTest(test.NoDBTestCase):
    ...
    def test_makepath(self):
        ...
        root_helper = jacket.compute.utils.get_root_helper()
    ...
    @mock.patch.object(jacket.compute.utils, 'execute')

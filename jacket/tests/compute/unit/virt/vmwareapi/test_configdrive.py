...
class ConfigDriveTestCase(test.NoDBTestCase):
    ...
    def setUp(self, mock_register):
        ...
        instance_values = {
            ...
            'memory_mb': 8192,
            'flavor': compute.Flavor(vcpus=4, extra_specs={}),
            'instance_type_id': 0,
            'vcpus': 4,
            'root_gb': 80,
            'image_ref': image_ref,
        ...
        self.test_instance = fake_instance.fake_instance_obj(self.context,
                                                             **instance_values)
        self.test_instance.flavor = compute.Flavor(vcpus=4, memory_mb=8192,
        ...
        # been faked out
        self.stub_out('compute.virt.configdrive.ConfigDriveBuilder.make_drive',
                      fake_make_drive)

        def fake_upload_iso_to_datastore(iso_path, instance, **kwargs):
            pass
        self.stub_out('compute.virt.vmwareapi.images.upload_iso_to_datastore',

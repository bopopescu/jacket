...
from jacket.compute.virt.vmwareapi import network_util
...
class GetNetworkWithTheNameTestCase(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        fake.reset()
        self.stub_out('compute.virt.vmwareapi.driver.VMwareAPISession.vim',
                      stubs.fake_vim_prop)
        self.stub_out('compute.virt.vmwareapi.driver.'

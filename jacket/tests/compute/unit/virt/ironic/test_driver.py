...
from jacket.compute.virt.ironic import client_wrapper as cw
from jacket.compute.virt.ironic import driver as ironic_driver
...
class IronicDriverTestCase(test.NoDBTestCase):
    ...
    @mock.patch.object(compute.Instance, 'refresh')
    ...
    def _test_spawn(self, mock_sf, mock_pvifs, mock_adf, mock_wait_active,
        ...
        fake_flavor = compute.Flavor(ephemeral_gb=0)
    ...
    def _test_rebuild(self, mock_save, mock_get, mock_driver_fields,
        ...
        image_meta = ironic_utils.get_test_image_meta()
        flavor_id = 5
        flavor = compute.Flavor(flavor_id=flavor_id, name='baremetal')

...
def intercept_log_messages():
    try:
        mylog = logging.getLogger('compute')
        stream = cStringIO()
...
class ImageCacheManagerTestCase(test.NoDBTestCase):
    ...
    def test_list_base_images(self):
        ...
        base_dir = '/var/lib/compute/instances/_base'
        self.flags(instances_path='/var/lib/compute/instances')
    ...
    def _make_base_file(self, checksum=True, lock=True):
        ...
        with utils.tempdir() as tmpdir:
            ...
            if lock:
                ...
                lockname = os.path.join(lockdir, 'compute-aaa')
                os.mkdir(lockdir)
    ...
    def test_remove_base_file(self):
        with self._make_base_file() as fname:
            ...
            lock_name = 'compute-' + os.path.split(fname)[-1]
    ...
    def test_configured_checksum_path(self):
        with utils.tempdir() as tmpdir:
            ...
            self.mox.StubOutWithMock(
                compute.block_device.BlockDeviceMappingList,
                'get_by_instance_uuid')
    ...
    def test_run_image_cache_manager_pass(self):
        ...
        with utils.tempdir() as tmpdir:
            ...
            self.stub_out('compute.db.instance_get_all_by_filters',

...
CONF = cfg.CONF
CONF.import_opt('fixed_key', 'compute.keymgr.conf_key_mgr', group='keymgr')
...
class _ImageTestCase(object):
    ...
    def setUp(self):
        ...
        self.INSTANCE = compute.Instance(id=1, uuid=uuidutils.generate_uuid())
    ...
    @mock.patch('compute.virt.disk.api.get_disk_size')

...
class LibvirtConfigGuestConsoleTest(LibvirtConfigBaseTest):
    ...
    def test_config_type_file_with_target_type(self):
        ...
        obj.source_path = "/var/lib/compute/instances/uuid/console.log"

        xml = obj.to_xml()
        self.assertXmlEqual(xml, """
            <console type="file">
                <source path="/var/lib/compute/instances/uuid/console.log"/>
                <target type="sclplm"/>
            </console>
            """)
...
class LibvirtConfigGuestMetadataNovaTest(LibvirtConfigBaseTest):
    ...
    def test_config_metadata(self):
        ...
        xml = meta.to_xml()
        self.assertXmlEqual(xml, """
    <compute:instance xmlns:compute='http://openstack.org/xmlns/libvirt/compute/1.0'>
      <compute:package version="2014.2.3"/>
      <compute:name>moonbuggy</compute:name>
      <compute:creationTime>2009-02-13 23:31:30</compute:creationTime>
      <compute:flavor name="m1.lowgravity">
        <compute:memory>2048</compute:memory>
        <compute:disk>50</compute:disk>
        <compute:swap>10</compute:swap>
        <compute:ephemeral>10</compute:ephemeral>
        <compute:vcpus>8</compute:vcpus>
      </compute:flavor>
      <compute:owner>
        <compute:user
         uuid="3472c2a6-de91-4fb5-b618-42bc781ef670">buzz</compute:user>
        <compute:project
         uuid="f241e906-010e-4917-ae81-53f4fb8aa021">moonshot</compute:project>
      </compute:owner>
      <compute:root type="image" uuid="fe55c69a-8b2e-4bbc-811a-9ad2023a0426"/>
    </compute:instance>
        """)

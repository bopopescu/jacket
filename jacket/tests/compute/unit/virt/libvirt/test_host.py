...
class HostTestCase(test.NoDBTestCase):
    ...
    def test_connect_auth_cb_exception(self, log_mock):
        creds = dict(authname='compute', password='verybadpass')
    ...
    def test_get_domain(self, fake_get_domain):
        ...
        instance = compute.Instance(id="124")
    ...
    def test_cpu_features_bug_1217630(self):
        ...
        with mock.patch('compute.virt.libvirt.host.libvirt') as mock_libvirt:
...
<capabilities>
  <host>
    ...
    @mock.patch('compute.virt.libvirt.host.Host.find_secret')

...
from jacket.compute.virt.libvirt import vif
...
class LibvirtVifTestCase(test.NoDBTestCase):
    ...
    instance = compute.Instance(id=1,
    ...
    def test_model_qemu_no_firewall(self):
        self.flags(firewall_driver="compute.virt.firewall.NoopFirewallDriver")
    ...
    def test_model_qemu_iptables(self):
        self.flags(firewall_driver="compute.virt.firewall.IptablesFirewallDriver")
        self._test_model_qemu(
            self.vif_bridge,
            self.vif_ovs,
            self.vif_ivs,
    ...
    @mock.patch('compute.network.linux_net.device_exists')

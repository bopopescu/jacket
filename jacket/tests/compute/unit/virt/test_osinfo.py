...
from jacket.compute.virt import osinfo
...
class LibvirtOsInfoTest(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.img_meta = compute.ImageMeta.from_dict(image_meta)
        self.useFixture(fixtures.MonkeyPatch(
            'compute.virt.osinfo.libosinfo',
            fakelibosinfo))
        self.useFixture(fixtures.MonkeyPatch(
            'compute.virt.osinfo._OsInfoDatabase._instance',
            None))
    ...
    def test_hardware_properties_from_osinfo(self):
        ...
        img_meta = compute.ImageMeta.from_dict(img_meta)

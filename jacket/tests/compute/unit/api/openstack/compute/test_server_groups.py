...
class ServerGroupTestV21(test.TestCase):
    ...
    def _create_instance(self, context):
        instance = compute.Instance(context=context, image_ref=1, node='node1',
    ...
    def _create_instance_group(self, context, members):
        ig = compute.InstanceGroup(context=context, name='fake_name',
    ...
    @mock.patch.object(jacket.db.compute, 'instance_group_get_all_by_project_id')
    @mock.patch.object(jacket.db.compute, 'instance_group_get_all')
    ...
    def test_delete_server_group_by_id(self):
        ...
        self.stub_out('jacket.compute.instance_group_delete',
                      server_group_delete)
        self.stub_out('jacket.compute.instance_group_get',
                      return_server_group)

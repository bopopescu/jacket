...
class MicroversionsTest(test.NoDBTestCase):
    ...
    @mock.patch("compute.api.openstack.APIRouterV21.api_extension_namespace",
                return_value='compute.api.v21.test_extensions')
    ...
    @mock.patch("compute.api.openstack.api_version_request.max_api_version")
    @mock.patch("compute.api.openstack.APIRouterV21.api_extension_namespace",
                return_value='compute.api.v21.test_extensions')

...
from jacket.api.compute.openstack.compute import limits as limits_v21
...
class BaseLimitTestSuite(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(jacket.compute.quota.QUOTAS, "get_project_quotas",
...
class LimitsControllerTestV21(BaseLimitTestSuite):
    ...
    def _get_index_request(self, accept_header="application/json",
        ...
        context = jacket.compute.context.RequestContext('testuser', 'testproject')
        request.environ["compute.context"] = context
        return request
    ...
    def _populate_limits(self, request):
        ...
        request.environ["compute.limits"] = _limits
        return request
    ...
    def _test_index_json(self, tenant_id=None):
        ...
        context = request.environ["compute.context"]
        ...
        with mock.patch('compute.quota.QUOTAS.get_project_quotas') as \
                get_project_quotas:

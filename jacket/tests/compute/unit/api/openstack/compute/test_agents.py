...
from jacket.api.compute.openstack.compute import agents as agents_v21
from jacket.api.compute.openstack.compute.legacy_v2.contrib import agents as agents_v2
...
class AgentsTestV21(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.stub_out("compute.compute.agent_build_get_all", fake_agent_build_get_all)
        self.stub_out("compute.compute.agent_build_update", fake_agent_build_update)
        self.stub_out("compute.compute.agent_build_destroy", fake_agent_build_destroy)
        self.stub_out("compute.compute.agent_build_create", fake_agent_build_create)
    ...
    def test_agents_create_with_existed_agent(self):
        ...
        self.stub_out('compute.compute.agent_build_create',
    ...
    def test_agents_delete_with_id_not_found(self):
        with mock.patch.object(compute, 'agent_build_destroy',
    ...
    def test_agents_update_with_id_not_found(self):
        with mock.patch.object(compute, 'agent_build_update',
            side_effect=exception.AgentBuildNotFound(id=1)):
            body = {'para': {'version': '7.0',
                    'url': 'http://example.com/path/to/resource',
                    'md5hash': 'add6bb58e139be103324d04d82d8f545'}}

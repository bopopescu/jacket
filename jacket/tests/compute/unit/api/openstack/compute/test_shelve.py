...
from jacket.api.compute.openstack.compute.legacy_v2.contrib import shelve as shelve_v2
from jacket.api.compute.openstack.compute import shelve as shelve_v21

...
from jacket.api.compute.openstack.compute import \
...
class TestSecurityGroupDefaultRulesV21(test.TestCase):
    ...
    @mock.patch('compute.db.security_group_default_rule_list',
    ...
    @mock.patch('jacket.compute.security_group_default_rule_get',
                side_effect=(exception.
                    SecurityGroupDefaultRuleNotFound("Rule Not Found")))
    ...
    def test_delete_security_group_default_rule(self):
        ...
        self.stub_out('compute.db.security_group_default_rule_destroy',
                      security_group_default_rule_destroy)
        self.stub_out('compute.db.security_group_default_rule_get',
    ...
    @mock.patch('jacket.compute.security_group_default_rule_destroy',
                side_effect=(exception.
                    SecurityGroupDefaultRuleNotFound("Rule Not Found")))
    ...
    def test_security_group_ensure_default(self):
        ...
        sg = jacket.db.compute.security_group_ensure_default(ctxt)
        rules = jacket.db.compute.security_group_rule_get_by_security_group(ctxt, sg.id)

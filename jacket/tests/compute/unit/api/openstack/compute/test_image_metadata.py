...
from jacket.api.compute.openstack.compute import image_metadata as image_metadata_v21
...
CHK_QUOTA_STR = 'compute.api.openstack.common.check_img_metadata_properties_quota'
...
class ImageMetaDataTestV21(test.NoDBTestCase):
    ...
    @mock.patch('compute.image.api.API.get', return_value=get_image_123())
    ...
    @mock.patch('compute.image.api.API.update')
    @mock.patch('compute.image.api.API.get', return_value=get_image_123())
    ...
    def test_image_not_authorized_update_all(self, _get_mocked):
        image_id = 131
        # see compute.tests.unit.api.openstack.fakes:_make_image_fixtures

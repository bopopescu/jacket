...
from jacket.api.compute.openstack.compute import fixed_ips as fixed_ips_v21
from jacket.api.compute.openstack.compute.legacy_v2.contrib import fixed_ips \
        as fixed_ips_v2
...
class FixedIpTestV21(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.stub_out("compute.db.fixed_ip_get_by_address",
                      fake_fixed_ip_get_by_address)
        self.stub_out("compute.db.fixed_ip_update", fake_fixed_ip_update)

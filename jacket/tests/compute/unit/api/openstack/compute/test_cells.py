...
from jacket.api.compute.openstack.compute import cells as cells_ext_v21
...
class CellsTestV21(BaseCellsTest):
    ...
    def _cell_delete(self):
        ...
        req.environ['compute.context'] = self.context
    ...
    def test_cell_delete_fails_for_invalid_policy(self):
        ...
        req = self._get_request("cells/cell999")
        req.environ['compute.context'] = self.context
        req.environ["compute.context"].is_admin = False

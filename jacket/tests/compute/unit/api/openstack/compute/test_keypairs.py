...
from jacket.api.compute.openstack.compute import keypairs as keypairs_v21
from jacket.api.compute.openstack.compute.legacy_v2.contrib import keypairs \
        as keypairs_v2
...
class KeypairsTestV21(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stub_out("compute.db.key_pair_get_all_by_user",
                      db_key_pair_get_all_by_user)
        self.stub_out("compute.db.key_pair_create",
                      db_key_pair_create)
        self.stub_out("compute.db.key_pair_destroy",
                      db_key_pair_destroy)
        self.flags(
    ...
    def test_keypair_create_duplicate(self):
        self.stub_out("compute.db.key_pair_create", db_key_pair_create_duplicate)
    ...
    def test_keypair_show(self):
        ...
        self.stub_out("compute.db.key_pair_get", _db_key_pair_get)
    ...
    def test_show_server(self):
        self.stub_out('compute.db.instance_get',
    ...
    def test_detail_servers(self, mock_get_all):
        ...
        # having to lazy-load.
        mock_get_all.return_value = compute.InstanceList(
            compute=[fakes.stub_instance_obj(ctxt=None, id=1),
...
class KeypairPolicyTestV21(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.stub_out("compute.db.key_pair_get_all_by_user",
                      db_key_pair_get_all_by_user)
        self.stub_out("compute.db.key_pair_destroy", db_key_pair_destroy)
    ...
    def test_keypair_create_pass_policy(self, mock_create):
        keypair_obj = compute.KeyPair(name='', public_key='',
                                      fingerprint='', user_id='')
        ...
        self.assertIn('keypair', res)
        req = self.req.environ['compute.context']

...
class DiskConfigTestCaseV21(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stub_out('compute.db.instance_get', fake_instance_get)
        ...
        self.stub_out('compute.db.instance_get_all', fake_instance_get_all)
        ...
        def fake_instance_create(context, inst_, session=None):
            ...
            def fake_instance_get_all_for_create(context, *args, **kwargs):
                return [inst]
            self.stub_out('compute.db.instance_get_all',
        ...
        self.stub_out('compute.db.instance_create', fake_instance_create)

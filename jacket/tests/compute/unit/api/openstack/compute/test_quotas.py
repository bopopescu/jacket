...
from jacket.api.compute.openstack.compute.legacy_v2.contrib import quotas as quotas_v2
from jacket.api.compute.openstack.compute import quota_sets as quotas_v21
...
class QuotaSetsTestV21(BaseQuotaSetsTest):
    ...
    def test_validate_quota_limit(self):
        ...
        self.assertRaises(webob.exc.HTTPBadRequest,
                          self.controller._validate_quota_limit,
                          resource, compute.MAX_INT + 1, -1, -1)
    ...
    @mock.patch('compute.objects.Quotas.create_limit')
    ...
    @mock.patch('compute.api.validation.validators._SchemaValidator.validate')
    @mock.patch('compute.objects.Quotas.create_limit')
    ...
    def test_quotas_delete(self):
        ...
        quota.QUOTAS.destroy_all_by_project(req.environ['compute.context'],
                                            1234)
        self.mox.ReplayAll()
...
class UserQuotasTestV21(BaseQuotaSetsTest):
    ...
    def test_user_quotas_delete(self):
        ...
        quota.QUOTAS.destroy_all_by_project_and_user(
            req.environ['compute.context'], 1234, '1')
        self.mox.ReplayAll()
        res = self.controller.delete(req, 1234)
        self.mox.VerifyAll()
        self.assertEqual(202, self.get_delete_status_int(res))

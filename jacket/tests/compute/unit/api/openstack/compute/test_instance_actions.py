...
from jacket.api.compute.openstack.compute import instance_actions as instance_actions_v21
...
class InstanceActionsTestV21(test.NoDBTestCase):
    ...
    def fake_get(self, context, instance_uuid, expected_attrs=None,
                     want_objects=False):
        return compute.Instance(uuid=instance_uuid)
    ...
    def test_list_actions(self):
        ...
        self.stub_out('compute.db.actions_get', fake_get_actions)
        req = self._get_http_req('os-instance-actions')
    ...
    def test_get_action_with_events_allowed(self):
        ...
        self.stub_out('compute.db.action_get_by_request_id', fake_get_action)
        self.stub_out('compute.db.action_events_get', fake_get_events)
        req = self._get_http_req('os-instance-actions/1',
    ...
    def test_action_not_found(self):
        ...
        self.stub_out('compute.db.action_get_by_request_id', fake_no_action)
        req = self._get_http_req('os-instance-actions/1')

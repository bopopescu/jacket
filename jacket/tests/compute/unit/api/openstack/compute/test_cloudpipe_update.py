...
from jacket.api.compute.openstack.compute import cloudpipe as clup_v21
from jacket.api.compute.openstack.compute.legacy_v2.contrib import cloudpipe_update \
        as clup_v2
...
class CloudpipeUpdateTestV21(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.stub_out("compute.db.project_get_networks",
                      fake_project_get_networks)
        self.stub_out("compute.db.network_update", fake_network_update)
        self._setup()

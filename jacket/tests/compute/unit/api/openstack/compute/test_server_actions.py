...
class ServerActionsControllerTestV21(test.TestCase):
    ...
    def test_rebuild_server_not_found(self):
        ...
        self.stub_out('compute.db.instance_get_by_uuid', server_not_found)
    ...
    def test_rebuild_accessIP(self):
        ...
        self.stubs.Set(compute.Instance, 'save', fake_save)
    ...
    @mock.patch('compute.compute.api.API.resize',
    ...
    def _do_test_create_volume_backed_image(self, extra_properties):
        ...
        self.stub_out('compute.db.instance_get_by_uuid', instance)

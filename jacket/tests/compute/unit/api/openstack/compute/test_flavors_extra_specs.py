...
from jacket.api.compute.openstack.compute import flavors_extraspecs \
        as flavorextraspecs_v21
from jacket.api.compute.openstack.compute.legacy_v2.contrib import flavorextraspecs \
...
class FlavorsExtraSpecsTestV21(test.TestCase):
    ...
    def test_index(self):
        ...
        with mock.patch('compute.db.flavor_get_by_flavor_id') as mock_get:
    ...
    def test_index_no_data(self):
        self.stub_out('compute.db.flavor_extra_specs_get',
    ...
    def test_delete(self):
        flavor = dict(test_flavor.fake_flavor,
                      extra_specs={'key5': 'value5'})
        self.stub_out('compute.db.flavor_extra_specs_delete',
    ...
    def test_create(self):
        self.stub_out('compute.db.flavor_extra_specs_update_or_create',
    ...
    @mock.patch('compute.db.flavor_extra_specs_update_or_create')

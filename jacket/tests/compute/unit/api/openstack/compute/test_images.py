...
from jacket.api.compute.openstack.compute import images as images_v21
from jacket.api.compute.openstack.compute.legacy_v2 import images
from jacket.api.compute.openstack.compute.views import images as images_view
from jacket.compute import exception
from jacket.compute.image import glance
from jacket.compute import test
from jacket.tests.compute.unit.api.openstack import fakes
from jacket.tests.compute.unit import image_fixtures
...
class ImagesControllerTestV21(test.NoDBTestCase):
    ...
    @mock.patch('compute.image.api.API.get', return_value=IMAGE_FIXTURES[0])
    ...
    @mock.patch('compute.image.api.API.get', return_value=IMAGE_FIXTURES[1])
    ...
    @mock.patch('compute.image.api.API.get',
    ...
    @mock.patch('compute.image.api.API.get_all', return_value=IMAGE_FIXTURES)
    ...
    @mock.patch('compute.image.api.API.get_all')
    ...
    @mock.patch('compute.image.api.API.get_all', side_effect=exception.Invalid)
    ...
    @mock.patch('compute.image.api.API.delete')
    ...
    @mock.patch('compute.image.api.API.get_all', return_value=[IMAGE_FIXTURES[0]])

...
from jacket.api.compute.openstack.compute import console_auth_tokens \
        as console_auth_tokens_v21
from jacket.api.compute.openstack.compute.legacy_v2.contrib import console_auth_tokens \

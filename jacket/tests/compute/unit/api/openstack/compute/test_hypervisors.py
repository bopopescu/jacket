...
from jacket.api.compute.openstack.compute import hypervisors \
        as hypervisors_v21
from jacket.api.compute.openstack.compute.legacy_v2.contrib import hypervisors \
        as hypervisors_v2
...
TEST_HYPERS_OBJ = [compute.ComputeNode(**hyper_dct)
...
class HypervisorsTestV21(test.NoDBTestCase):
    # copying the compute locally so the cells testcases can provide their own
    ...
    def setUp(self):
        ...
        self.stub_out('compute.db.compute_node_statistics',

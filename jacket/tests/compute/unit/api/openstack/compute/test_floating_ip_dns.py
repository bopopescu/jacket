...
from jacket.api.compute.openstack.compute import floating_ip_dns \
        as fipdns_v21
...
class FloatingIpDNSTestV21(test.TestCase):
    ...
    def _delete_floating_ip(self):
        compute.floating_ip_destroy(self.context, test_ipv4_address)
        compute.floating_ip_destroy(self.context, test_ipv6_address)

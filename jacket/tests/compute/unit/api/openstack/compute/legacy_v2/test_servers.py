...
from jacket.api.compute.openstack.compute.legacy_v2 import ips
...
from jacket.tests.compute.unit.objects import test_keypair
...
class ControllerTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stub_out('compute.compute.instance_add_security_group',
...
class ServersControllerTest(ControllerTest):
    ...
    @mock.patch('compute.compute.api.API.get_all')
...
class ServersControllerUpdateTest(ControllerTest):
    ...
    def test_update_server_adminPass_ignored(self):
        ...
        self.stub_out('compute.compute.instance_update', server_update)
        # FIXME (comstud)
...
class ServersControllerDeleteTest(ControllerTest):
    ...
    def test_delete_server_instance_while_deleting_host_up(self):
        ...
        self.stubs.Set(compute_api.API, 'get',
                       lambda api, *a, **k: return_server(*a, **k))
        self.stubs.Set(compute.Instance, 'save',
                       lambda *args, **kwargs: None)

        @classmethod
        def fake_get_by_compute_host(cls, context, host):
            return {'updated_at': timeutils.utcnow()}
        self.stubs.Set(compute.Service, 'get_by_compute_host',
...
class ServersControllerCreateTest(test.TestCase):
    ...
    def test_create_instance_with_security_group_enabled(self):
        ...
        self.stub_out('compute.compute.security_group_get_by_name', sec_group_get)
        # negative test
        self.assertRaises(webob.exc.HTTPBadRequest,
    ...
    def test_create_instance_above_quota_group_members(self):
        ...
        def fake_count(context, name, group, user_id):
            ...
            self.assertEqual(self.req.environ['compute.context'].user_id,
                             user_id)
            return 10

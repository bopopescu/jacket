...
from jacket.api.compute.openstack.compute import server_migrations
...
class ServerMigrationsTestsV223(ServerMigrationsTestsV21):
    ...
    @mock.patch('compute.compute.api.API.get_migrations_in_progress_by_instance')
    @mock.patch('compute.compute.api.API.get')
    ...
    @mock.patch('compute.compute.api.API.get_migration_by_id_and_instance')
    @mock.patch('compute.compute.api.API.get')

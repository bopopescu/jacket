...
from jacket.compute.network.neutronv2 import api as neutron_api
...
from jacket.tests.compute.unit.api.openstack.compute import test_security_groups
...
class TestNeutronSecurityGroupsV21(
    ...
    def test_delete_security_group_in_use(self, refresh_info_cache_mock):
        ...
        with mock.patch.object(jacket.db.compute, 'instance_get_by_uuid',

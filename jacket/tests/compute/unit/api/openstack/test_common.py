...
class LimiterTest(test.NoDBTestCase):
    """Unit tests for the `compute.api.openstack.common.limited` method which
...
class PaginationParamsTest(test.NoDBTestCase):
    """Unit tests for the `compute.api.openstack.common.get_pagination_params`
...
class TestCollectionLinks(test.NoDBTestCase):
    ...
    @mock.patch('compute.api.openstack.common.ViewBuilder._get_next_link')

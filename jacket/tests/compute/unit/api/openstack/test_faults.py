...
class TestFaultWrapper(test.NoDBTestCase):
    """Tests covering `compute.api.openstack:FaultWrapper` class."""

    @mock.patch('oslo_i18n.translate')
    @mock.patch('compute.i18n.get_available_languages')
    def test_safe_exception_translated(self, mock_languages, mock_translate):
        ...
        wrapper = jacket.api.compute.openstack.FaultWrapper(raiser)
...
class TestFaults(test.NoDBTestCase):
    """Tests covering `compute.api.openstack.faults:Fault` class."""

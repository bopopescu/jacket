...
from jacket.db.compute.sqlalchemy import api as session
from jacket.compute import exception
from jacket.objects.compute import base as obj_base
from jacket.tests.compute import fixtures
from jacket.tests.compute.unit import conf_fixture
...
class TestOSAPIFixture(testtools.TestCase):
    @mock.patch('compute.objects.Service.get_by_host_and_binary')
    @mock.patch('compute.objects.Service.create')
    def test_responds_to_version(self, mock_service_create, mock_get):
        ...
        self.useFixture(conf_fixture.ConfFixture())
        self.useFixture(fixtures.RPCFixture('compute.test'))

...
from jacket.compute import filters
from jacket.compute import loadables
...
class FiltersTestCase(test.NoDBTestCase):
    ...
    @mock.patch('compute.filters.BaseFilter._filter_one')
    ...
    def test_get_filtered_objects(self):
        ...
        self.stub_out('compute.loadables.BaseLoader.__init__',
    ...
    def test_get_filtered_objects_info_log_none_returned(self):
        ...
        fake_uuid = "uuid"
        spec_obj = compute.RequestSpec(instance_uuid=fake_uuid)

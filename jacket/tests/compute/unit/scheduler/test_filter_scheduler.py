...
from jacket.compute.scheduler import filter_scheduler
...
from jacket.compute import test  # noqa
from jacket.tests.compute.unit.scheduler import fakes
from jacket.tests.compute.unit.scheduler import test_scheduler
...
class FilterSchedulerTestCase(test_scheduler.SchedulerTestCase):
    ...
    def test_schedule_happy_day(self, mock_get_extra, mock_get_all,
        ...
        self.stub_out('compute.scheduler.weights.HostWeightHandler.'
    ...
    def test_schedule_host_pool(self, mock_get_extra, mock_get_all,
        ...
        spec_obj = compute.RequestSpec(
            ...
            os_type='Linux',
            uuid='fake-uuid',
            flavor=compute.Flavor(root_gb=512,
                                  memory_mb=512,
                                  ephemeral_gb=0,
                                  vcpus=1),
            pci_requests=None,
    ...
    @mock.patch('compute.scheduler.host_manager.HostManager._get_instance_info')
    @mock.patch('compute.compute.ServiceList.get_by_binary',
                return_value=fakes.SERVICES)
    @mock.patch('compute.compute.ComputeNodeList.get_all',
                return_value=fakes.COMPUTE_NODES)
    ...
    def test_select_destinations_notifications(self, mock_schedule):
        ...
        with mock.patch.object(self.driver.notifier, 'info') as mock_info:
            expected = {'num_instances': 1,
                        ...
                        'instance_type': {},
                        'image': {}}
            spec_obj = compute.RequestSpec(num_instances=1,
                                           instance_uuid='uuid1')
    ...
    def test_select_destinations_no_valid_host(self, mock_schedule):
        ...
        self.assertRaises(exception.NoValidHost,
                ...
                compute.RequestSpec(num_instances=1))
        ...
        with mock.patch.object(self.driver, '_schedule',
            ...
            try:
                self.driver.select_destinations(
                    self.context, compute.RequestSpec(num_instances=3))

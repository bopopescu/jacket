...
from jacket.compute.scheduler.client import query as scheduler_query_client
from jacket.compute.scheduler.client import report as scheduler_report_client
...
class SchedulerReportClientTestCase(test.NoDBTestCase):
    ...
    @mock.patch.object(compute.ComputeNode, 'save')
...
class SchedulerQueryClientTestCase(test.NoDBTestCase):
    ...
    def test_update_aggregates(self, mock_update_aggs):
        aggregates = [compute.Aggregate(id=1)]
    ...
    def test_delete_aggregate(self, mock_delete_agg):
        aggregate = compute.Aggregate(id=1)

                           ...
                           cells=[
                             compute.NUMACell(
                               ...
                               cpu_usage=0, memory_usage=0, mempages=[
                                 compute.NUMAPagesTopology(size_kb=16,
                                                           total=387184,
                                                           used=0),
                                 compute.NUMAPagesTopology(size_kb=2048,
                                                           total=512, used=0)],
                               siblings=[], pinned_cpus=set([])),
                             compute.NUMACell(
                               id=1, cpuset=set([3, 4]), memory=512,
                               cpu_usage=0, memory_usage=0, mempages=[
                                 compute.NUMAPagesTopology(size_kb=4,
                                                           total=1548736,
                                                           used=0),
                                 compute.NUMAPagesTopology(size_kb=2048,
                                                           total=512, used=0)],
...
NUMA_TOPOLOGY_W_HT = compute.NUMATopology(cells=[
    compute.NUMACell(
...
SERVICES = [
        compute.Service(host='host1', disabled=False),
        compute.Service(host='host2', disabled=True),
        compute.Service(host='host3', disabled=False),
        compute.Service(host='host4', disabled=False),
]

...
class ChanceSchedulerTestCase(test_scheduler.SchedulerTestCase):
    ...
    def test_filter_hosts_avoid(self):
        ...
        spec_obj = compute.RequestSpec(ignore_hosts=['host2'])
    ...
    def test_filter_hosts_no_avoid(self):
        ...
        hosts = ['host1', 'host2', 'host3']
        spec_obj = compute.RequestSpec(ignore_hosts=[])
    ...
    def test_select_destinations(self, mock_random_choice):
        ...
        self.stub_out('compute.scheduler.chance.ChanceScheduler.hosts_up',
                      _return_hosts)

        spec_obj = compute.RequestSpec(num_instances=2, ignore_hosts=None)
    ...
    def test_select_destinations_no_valid_host(self):
        ...
        self.stub_out('compute.scheduler.chance.ChanceScheduler.hosts_up',
                      _return_hosts)
        self.stub_out('compute.scheduler.chance.ChanceScheduler._filter_hosts',
                      _return_no_host)

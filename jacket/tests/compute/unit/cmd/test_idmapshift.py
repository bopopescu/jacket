...
from jacket.cmd.compute import idmapshift
...
class ShiftPathTestCase(BaseTestCase):
    ...
    @mock.patch('os.lchown')
    @mock.patch('compute.cmd.idmapshift.print_chown')
    @mock.patch('os.lstat')
...
class ShiftDirTestCase(BaseTestCase):
    @mock.patch('compute.cmd.idmapshift.shift_path')
...
class ConfirmDirTestCase(BaseTestCase):
    ...
    @mock.patch('compute.cmd.idmapshift.confirm_path')
    @mock.patch('os.path.join')
    @mock.patch('os.walk')
...
class MainTestCase(BaseTestCase):
    @mock.patch('compute.cmd.idmapshift.shift_dir')
    ...
    @mock.patch('compute.cmd.idmapshift.shift_dir')
    @mock.patch('compute.cmd.idmapshift.confirm_dir')
    @mock.patch('argparse.ArgumentParser')

...
class TestGlanceClientWrapper(test.NoDBTestCase):
    ...
    @mock.patch('compute.image.glance._glanceclient_from_endpoint')
    ...
    @mock.patch('compute.image.glance.LOG')
    @mock.patch('time.sleep')
    @mock.patch('compute.image.glance._glanceclient_from_endpoint')
...
class TestDownloadNoDirectUri(test.NoDBTestCase):
    ...
    @mock.patch('compute.image.glance.GlanceImageService.show')
    ...
    @mock.patch('compute.image.glance.GlanceImageService._get_transfer_module')
    @mock.patch('compute.image.glance.GlanceImageService.show')
...
class TestDownloadSignatureVerification(test.NoDBTestCase):
    ...
    @mock.patch('compute.image.glance.LOG')
    @mock.patch('compute.image.glance.GlanceImageService.show')
    @mock.patch('compute.signature_utils.get_verifier')
...
class TestShow(test.NoDBTestCase):
    ...
    @mock.patch('compute.image.glance._translate_from_glance')
    @mock.patch('compute.image.glance._is_image_available')
    ...
    @mock.patch('compute.image.glance._reraise_translated_image_exception')
    @mock.patch('compute.image.glance._translate_from_glance')
    @mock.patch('compute.image.glance._is_image_available')
...
class TestDetail(test.NoDBTestCase):
    ...
    @mock.patch('compute.image.glance._extract_query_params')
    @mock.patch('compute.image.glance._translate_from_glance')
    @mock.patch('compute.image.glance._is_image_available')
    ...
    @mock.patch('compute.image.glance._reraise_translated_exception')
    @mock.patch('compute.image.glance._extract_query_params')
    @mock.patch('compute.image.glance._translate_from_glance')
    @mock.patch('compute.image.glance._is_image_available')
...
class TestCreate(test.NoDBTestCase):
    ...
    @mock.patch('compute.image.glance._translate_from_glance')
    @mock.patch('compute.image.glance._translate_to_glance')
...
class TestUpdateGlanceImage(test.NoDBTestCase):
    @mock.patch('compute.image.glance.GlanceImageService')

...
def stub_out_image_service(test):
    ...
    :param test: instance of compute.test.TestCase
    :returns: The stubbed out FakeImageService object
    """
    image_service = FakeImageService()
    test.stub_out('compute.image.glance.get_remote_image_service',
                  lambda x, y: (image_service, y))
    test.stub_out('compute.image.glance.get_default_image_service',

...
"""
Unit Tests for compute.compute.rpcapi
"""
...
class ComputeRpcAPITestCase(test.NoDBTestCase):
    ...
    @mock.patch('compute.objects.migrate_data.LiveMigrateData.'
    ...
    @mock.patch('compute.objects.migrate_data.LiveMigrateData.from_legacy_dict')

...
from jacket.tests.compute.unit import fake_crypto
...
class KeypairAPITestCase(test_compute.BaseTestCase):
    ...
    def _keypair_db_call_stubs(self):
        ...
        self.stub_out("compute.db.key_pair_create", db_key_pair_create)
        self.stub_out("compute.db.key_pair_destroy", db_key_pair_destroy)
        self.stub_out("compute.db.key_pair_get", db_key_pair_get)

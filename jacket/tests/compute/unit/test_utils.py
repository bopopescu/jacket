...
class GenericUtilsTestCase(test.NoDBTestCase):
    ...
    def test_read_file_as_root(self):
        ...
        self.stub_out('compute.utils.execute', fake_execute)
    ...
    def test_use_rootwrap(self):
        ...
        self.assertEqual('sudo compute-rootwrap foo', cmd)

    @mock.patch('compute.utils.RootwrapProcessHelper')
    ...
    @mock.patch('compute.utils.RootwrapDaemonHelper')
    ...
    def test_ssh_execute(self):
        expected_args = ('ssh', '-o', 'BatchMode=yes',
                         'remotehost', 'ls', '-l')
        with mock.patch('compute.utils.execute') as mock_method:
...
class RootwrapDaemonTesetCase(test.NoDBTestCase):
    ...
    def test_get_client(self, mock_client):
        ...
        mock_client.assert_called_once_with(
            ["sudo", "compute-rootwrap-daemon", mock_conf])

    @mock.patch('compute.utils.LOG.info')
    ...
    @mock.patch('compute.utils.LOG.log')
...
class MonkeyPatchTestCase(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        self.example_package = 'compute.tests.unit.monkey_patch_example.'
        self.flags(
            monkey_patch=True,
    ...
    def test_monkey_patch(self):
        utils.monkey_patch()
        compute.tests.unit.monkey_patch_example.CALLED_FUNCTION = []
        from jacket.tests.compute.unit.monkey_patch_example import example_a
        from jacket.tests.compute.unit.monkey_patch_example import example_b

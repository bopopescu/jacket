...
DEFAULT_FLAVOR_OBJS = [
    compute.Flavor._obj_from_primitive(CONTEXT, compute.Flavor.VERSION,
...
class InstanceTypeTestCase(test.TestCase):
    ...
    def test_flavor_get_by_None_name_returns_default(self):
        ...
        self.assertIsInstance(default, compute.Flavor)
        self.assertIsInstance(actual, compute.Flavor)
    ...
    def test_will_get_instance_by_flavor_id(self):
        ...
        self.assertIsInstance(fetched, compute.Flavor)
    ...
    def test_get_all_flavors_sorted_list_sort(self):
        ...
        for i in range(len(all_flavors)):
            f = all_flavors[i]
            self.assertIsInstance(f, compute.Flavor)
...
class InstanceTypeFilteringTest(test.TestCase):
    ...
    def assertFilterResults(self, filters, expected):
        inst_types = compute.flavor_get_all(
...
class CreateInstanceTypeTest(test.TestCase):
    ...
    def test_memory_must_be_positive_db_integer(self):
        ...
        self.assertInvalidInput('flavor1', compute.MAX_INT + 1, 1, 120)
    ...
    def test_vcpus_must_be_positive_db_integer(self):
        ...
        self.assertInvalidInput('flavor1', 64, compute.MAX_INT + 1, 120)
    ...
    def test_root_gb_must_be_nonnegative_db_integer(self):
        ...
        self.assertInvalidInput('flavor1', 64, 1, compute.MAX_INT + 1)
    ...
    def test_ephemeral_gb_must_be_nonnegative_db_integer(self):
        ...
        self.assertInvalidInput('flavor1', 64, 1, 120,
                                ephemeral_gb=compute.MAX_INT + 1)
    ...
    def test_rxtx_factor_must_be_within_sql_float_range(self):
        ...
        compute.flavor_get_all(_context)
    ...
    def test_basic_create(self):
        ...
        original_list = compute.FlavorList.get_all(ctxt)
        ...
        new_list = compute.FlavorList.get_all(ctxt)
    ...
    def test_create_then_delete(self):
        ...
        self.assertRaises(exception.FlavorNotFound,
                          compute.Flavor.get_by_id, ctxt, flavor.id)

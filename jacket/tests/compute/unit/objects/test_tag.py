...
from jacket.objects.compute import tag
...
class _TestTagObject(object):
    @mock.patch('compute.db.instance_tag_add')
    ...
    @mock.patch('compute.db.instance_tag_delete')
    ...
    @mock.patch('compute.db.instance_tag_exists')
...
class _TestTagList(object):
    ...
    @mock.patch('compute.db.instance_tag_get_by_instance_uuid')
    ...
    @mock.patch('compute.db.instance_tag_set')
    ...
    @mock.patch('compute.db.instance_tag_delete_all')

...
from jacket.objects.compute import agent as agent_obj
...
class _TestAgent(object):
    ...
    @mock.patch('compute.db.agent_build_get_by_triple')
    ...
    @mock.patch('compute.db.agent_build_create')
    ...
    @mock.patch('compute.db.agent_build_get_all')

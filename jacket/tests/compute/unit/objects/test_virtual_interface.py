...
class _TestVirtualInterface(object):
    ...
    def test_get_by_id(self):
        with mock.patch.object(compute, 'virtual_interface_get') as get:
            get.return_value = fake_vif
            vif = vif_obj.VirtualInterface.get_by_id(self.context, 1)
            self._compare(self, fake_vif, vif)

    def test_get_by_uuid(self):
        with mock.patch.object(compute, 'virtual_interface_get_by_uuid') as get:
            get.return_value = fake_vif
    ...
    def test_get_by_address(self):
        with mock.patch.object(compute, 'virtual_interface_get_by_address') as get:
            get.return_value = fake_vif
    ...
    def test_get_by_instance_and_network(self):
        with mock.patch.object(compute,
    ...
    def test_create(self):
        ...
        with mock.patch.object(compute, 'virtual_interface_create') as create:
...
class _TestVirtualInterfaceList(object):
    def test_get_all(self):
        with mock.patch.object(compute, 'virtual_interface_get_all') as get:
            get.return_value = [fake_vif]
    ...
    def test_get_by_instance_uuid(self):
        with mock.patch.object(compute, 'virtual_interface_get_by_instance') as get:
            get.return_value = [fake_vif]

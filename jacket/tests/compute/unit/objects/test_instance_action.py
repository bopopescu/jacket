...
from jacket.objects.compute import instance_action
...
class _TestInstanceActionObject(object):
    @mock.patch.object(compute, 'action_get_by_request_id')
    ...
    @mock.patch.object(compute, 'action_start')
    ...
    @mock.patch.object(compute, 'action_finish')
    ...
    @mock.patch.object(compute, 'actions_get')
...
class _TestInstanceActionEventObject(object):
    @mock.patch.object(compute, 'action_event_get_by_id')
    ...
    @mock.patch.object(compute, 'action_event_start')
    ...
    @mock.patch.object(compute, 'action_event_finish')
    ...
    @mock.patch.object(compute, 'action_events_get')
    ...
    @mock.patch('compute.objects.instance_action.InstanceActionEvent.'

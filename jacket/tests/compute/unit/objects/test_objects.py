...
class TestObjToPrimitive(test.NoDBTestCase):
    ...
    def test_obj_to_primitive_list(self):
        ...
        class MyList(base.ObjectListBase, base.NovaObject):
            fields = {'compute': fields.ListOfObjectsField('MyObjElement')}
    ...
    def test_obj_to_primitive_recursive(self):
        ...
        class MyList(base.ObjectListBase, base.NovaObject):
            fields = {'compute': fields.ListOfObjectsField('MyObj')}

        mylist = MyList(compute=[MyObj(), MyObj()])
...
class TestObjMakeList(test.NoDBTestCase):
    ...
    def test_obj_make_list(self):
        class MyList(base.ObjectListBase, base.NovaObject):
            fields = {
                'compute': fields.ListOfObjectsField('MyObj'),
            }
...
class FakeIndirectionHack(fixture.FakeIndirectionAPI):
    def object_action(self, context, objinst, objmethod, args, kwargs):
        ...
        with mock.patch('compute.compute.base.NovaObject.'
...
class IndirectionFixture(fixtures.Fixture):
    def setUp(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
            'compute.compute.base.NovaObject.indirection_api',
...
class _TestObject(object):
    ...
    def test_obj_make_compatible_doesnt_skip_falsey_sub_objects(self):
        ...
        class MyList(base.ObjectListBase, base.NovaObject):
            ...
            fields = {'compute': fields.ListOfObjectsField('MyObjElement')}
            obj_relationships = {
                'compute': [('1.1', '1.1'), ('1.2', '1.2')],
            }

        mylist = MyList(compute=[])
...
class TestObjectSerializer(_BaseTestCase):
    ...
    def test_object_tree_backport(self, mock_get_versions):
        ...
        self.start_service('conductor',
                           manager='compute.conductor.manager.ConductorManager')

        # NOTE(danms): Actually register a complex set of compute,
...
class TestRegistry(test.NoDBTestCase):
    @mock.patch('compute.compute.base.compute')
...
class TestObjectVersions(test.NoDBTestCase):
    def test_versions(self):
        ...
        self.assertEqual(expected, actual,
                         'Some compute have changed; please make sure the '
    ...
    def test_list_obj_make_compatible(self):
        ...
        class TestListObj(base.ObjectListBase, base.NovaObject):
            VERSION = '1.5'
            fields = {'compute': fields.ListOfObjectsField('TestObj')}
            obj_relationships = {
                'compute': [('1.0', '1.1'), ('1.1', '1.2'),
                            ('1.3', '1.3'), ('1.5', '1.4')]
            }
    ...
    def test_list_obj_make_compatible_when_no_objects(self):
        # Test to make sure obj_make_compatible works with no 'compute'
        # If a List object ever has a version that did not contain the
        # 'compute' key, we need to make sure converting back to that version
        ...
        class TestListObj(base.ObjectListBase, base.NovaObject):
            VERSION = '1.1'
            fields = {'compute': fields.ListOfObjectsField('TestObj')}
            # pretend that version 1.0 didn't have 'compute'
            obj_relationships = {
                'compute': [('1.1', '1.1')]
            }
        ...
        my_list.obj_make_compatible(primitive_data,
                                    target_version='1.0')
        self.assertNotIn('compute', primitive_data,
                         "List was backported to before 'compute' existed."
                         " 'compute' should not be in the primitive.")

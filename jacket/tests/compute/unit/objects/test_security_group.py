...
class _TestSecurityGroupObject(object):
    ...
    def test_get(self):
        self.mox.StubOutWithMock(compute, 'security_group_get')
        compute.security_group_get(self.context, 1).AndReturn(fake_secgroup)
        self.mox.ReplayAll()
    ...
    def test_get_by_name(self):
        self.mox.StubOutWithMock(compute, 'security_group_get_by_name')
        compute.security_group_get_by_name(self.context, 'fake-project',
    ...
    def test_in_use(self):
        self.mox.StubOutWithMock(compute, 'security_group_in_use')
        compute.security_group_in_use(self.context, 123).AndReturn(True)
        self.mox.ReplayAll()
    ...
    def test_save(self):
        ...
        compute.security_group_update(self.context, 1,
    ...
    def test_refresh(self):
        ...
        self.mox.StubOutWithMock(compute, 'security_group_get')
        compute.security_group_get(self.context, 1).AndReturn(updated_secgroup)
        self.mox.ReplayAll()
        secgroup = security_group.SecurityGroup._from_db_object(
...
class _TestSecurityGroupListObject(object):
    def test_get_all(self):
        self.mox.StubOutWithMock(compute, 'security_group_get_all')
        compute.security_group_get_all(self.context).AndReturn(fake_secgroups)
        self.mox.ReplayAll()
    ...
    def test_get_by_project(self):
        self.mox.StubOutWithMock(compute, 'security_group_get_by_project')
        compute.security_group_get_by_project(self.context,
    ...
    def test_get_by_instance(self):
        ...
        self.mox.StubOutWithMock(compute, 'security_group_get_by_instance')
        compute.security_group_get_by_instance(self.context,

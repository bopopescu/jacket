...
from jacket.objects.compute import keypair
...
class _TestKeyPairObject(object):
    ...
    @mock.patch('compute.db.key_pair_get')
    ...
    @mock.patch('compute.db.key_pair_create')
    ...
    @mock.patch('compute.db.key_pair_destroy')
    ...
    @mock.patch('compute.db.key_pair_get_all_by_user')
    @mock.patch('compute.db.key_pair_count_by_user')

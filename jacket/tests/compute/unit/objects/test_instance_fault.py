...
from jacket.objects.compute import instance_fault
...
class _TestInstanceFault(object):
    def test_get_latest_for_instance(self):
        ...
        compute.instance_fault_get_by_instance_uuids(self.context, ['fake-uuid']
    ...
    @mock.patch('compute.cells.rpcapi.CellsAPI.instance_fault_create_at_top')
    @mock.patch('compute.compute.instance_fault_create')

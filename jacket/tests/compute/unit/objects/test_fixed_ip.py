...
from jacket.objects.compute import fixed_ip
...
class _TestFixedIPObject(object):
    ...
    @mock.patch('compute.db.fixed_ip_get')
    ...
    @mock.patch('compute.db.fixed_ip_get')
    @mock.patch('compute.db.network_get')
    ...
    @mock.patch('compute.db.fixed_ip_get_by_address')
    @mock.patch('compute.db.network_get')
    @mock.patch('compute.db.instance_get')
    ...
    @mock.patch('compute.db.fixed_ip_get_by_floating_address')
    ...
    @mock.patch('compute.db.fixed_ip_get_by_network_host')
    ...
    @mock.patch('compute.db.fixed_ip_associate')
    ...
    @mock.patch('compute.db.fixed_ip_associate_pool')
    ...
    @mock.patch('compute.db.fixed_ip_disassociate')
    ...
    @mock.patch('compute.db.fixed_ip_disassociate_all_by_timeout')
    ...
    @mock.patch('compute.db.fixed_ip_create')
    ...
    @mock.patch('compute.db.fixed_ip_update')
    ...
    @mock.patch('compute.db.fixed_ip_get_all')
    ...
    @mock.patch('compute.db.fixed_ip_get_by_instance')
    ...
    @mock.patch('compute.db.fixed_ip_get_by_host')
    ...
    @mock.patch('compute.db.fixed_ips_by_virtual_interface')
    ...
    @mock.patch('compute.db.fixed_ip_bulk_create')
    ...
    @mock.patch('compute.db.network_get_associated_fixed_ips')

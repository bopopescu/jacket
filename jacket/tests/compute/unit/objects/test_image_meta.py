...
class TestImageMeta(test.NoDBTestCase):
    def test_basic_attrs(self):
        ...
        self.assertIsInstance(image_meta.properties, compute.ImageMetaProps)
...
class TestImageMetaProps(test.NoDBTestCase):
    def test_normal_props(self):
        ...
        virtprops = compute.ImageMetaProps.from_dict(props)
    ...
    def test_legacy_compat(self):
        ...
        image_meta = compute.ImageMetaProps.from_dict(legacy_props)
    ...
    def test_get(self):
        props = compute.ImageMetaProps(os_distro='linux')
    ...
    def test_obj_make_compatible(self):
        ...
        obj = compute.ImageMetaProps(**props)

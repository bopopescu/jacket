...
class _TestInstanceInfoCacheObject(object):
    def test_get_by_instance_uuid(self):
        ...
        self.mox.StubOutWithMock(compute, 'instance_info_cache_get')
        compute.instance_info_cache_get(
    ...
    def test_get_by_instance_uuid_no_entries(self):
        self.mox.StubOutWithMock(compute, 'instance_info_cache_get')
        compute.instance_info_cache_get(self.context,
    ...
    def _save_helper(self, cell_type, update_cells):
        ...
        compute.instance_info_cache_update(
                self.context, uuids.info_instance,
    ...
    @mock.patch.object(compute, 'instance_info_cache_update')

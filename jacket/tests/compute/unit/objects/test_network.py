...
class _TestNetworkObject(object):
    ...
    @mock.patch('compute.db.network_get_by_uuid')
    ...
    @mock.patch('compute.db.network_get_by_cidr')
    ...
    @mock.patch('compute.db.network_update')
    @mock.patch('compute.db.network_set_host')
    ...
    @mock.patch('compute.db.network_associate')
    ...
    @mock.patch('compute.db.network_disassociate')
    ...
    @mock.patch('compute.db.network_create_safe')
    ...
    @mock.patch('compute.db.network_delete_safe')
    ...
    @mock.patch('compute.db.network_get_all')
    ...
    @mock.patch('compute.db.network_get_all_by_uuids')
    ...
    @mock.patch('compute.db.network_get_all_by_host')
    ...
    @mock.patch('compute.db.network_in_use_on_host')
    ...
    @mock.patch('compute.db.project_get_networks')

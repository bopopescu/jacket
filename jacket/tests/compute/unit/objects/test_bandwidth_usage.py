...
class _TestBandwidthUsage(test.TestCase):
    ...
    @staticmethod
    def _compare(test, compute, obj, ignored_fields=None):
        ...
        for field, value in compute.items():
            ...
            test.assertEqual(compute[field], obj[obj_field],
    ...
    @mock.patch.object(compute, 'bw_usage_get')
    ...
    @mock.patch.object(compute, 'bw_usage_get_by_uuids')

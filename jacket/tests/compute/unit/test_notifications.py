...
class NotificationsTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stub_out('compute.network.api.API.get_instance_nw_info',
                fake_get_nw_info)
    ...
    def _wrapped_create(self, params=None):
        ...
        inst = compute.Instance(image_ref=1,
    ...
    def test_send_no_state_change(self):
        ...
        def sending_no_state_change(context, instance, **kwargs):
            called[0] = True
        self.stub_out('compute.notifications._send_instance_update_notification',

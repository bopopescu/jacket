...
def fake_inst_obj(context):
    ...
    inst.info_cache = compute.InstanceInfoCache(context=context,
...
def fake_keypair_obj(name, data):
    return compute.KeyPair(name=name,
                           type='fake_type',
                           public_key=data)
...
class MetadataTestCase(test.TestCase):
    ...
    def test_format_instance_mapping(self):
        ...
        instance_ref0 = compute.Instance(**{'id': 0,
                         'uuid': 'e5fe5518-0288-4fa3-b0c4-c79764101b85',
                         'root_device_name': None,
                         'default_ephemeral_device': None,
                         'default_swap_device': None})
        instance_ref1 = compute.Instance(**{'id': 0,
                         'uuid': 'b65cee2f-8c69-4aeb-be2f-f79742548fc2',
                         'root_device_name': '/dev/sda1',
                         'default_ephemeral_device': None,
                         'default_swap_device': None})
    ...
    @mock.patch('compute.cells.rpcapi.CellsAPI.get_keypair_at_top')
...
class MetadataHandlerTestCase(test.TestCase):
    ...
    def test_user_data_non_existing_fixed_address(self):
        self.stub_out('compute.network.api.get_fixed_ip_by_address',

...
CONF.import_opt('floating_ip_dns_manager', 'compute.network.floating_ips')
CONF.import_opt('instance_dns_manager', 'compute.network.floating_ips')
...
class ConfFixture(config_fixture.Config):
    ...
    def setUp(self):
        ...
        self.conf.set_default('api_paste_config',
                              paths.state_path_def('etc/compute/api-paste.ini'))
        self.conf.set_default('host', 'fake-mini')
        self.conf.set_default('compute_driver',
                              'compute.virt.fake.SmallFakeDriver')
        ...
        self.conf.set_default('floating_ip_dns_manager',
                              'compute.tests.unit.utils.dns_manager')

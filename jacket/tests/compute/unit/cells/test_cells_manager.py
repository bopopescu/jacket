...
class CellsManagerClassTestCase(test.NoDBTestCase):
    ...
    def test_build_instances(self):
        build_inst_kwargs = {'instances': [compute.Instance(),
                                           compute.Instance()]}
    ...
    def test_heal_instances(self):
        ...
        self.stubs.Set(compute.Instance, 'get_by_uuid',
    ...
    def test_service_get_all(self):
        ...
        for i in range(3):
            ...
            for service in FAKE_SERVICES:
                fake_service = compute.Service(**service)
    ...
    def test_service_get_by_compute_host(self):
        fake_cell = 'fake-cell'
        fake_service = compute.Service(**FAKE_SERVICES[0])
    ...
    def test_service_update(self):
        ...
        self.msg_runner.service_update(self.ctxt,
                fake_cell, 'fake-host', 'compute-api',
        ...
        response = self.cells_manager.service_update(
            self.ctxt, host_name=cell_and_host, binary='compute-api',
    ...
    def test_compute_node_get_all(self):
        ...
        for i in range(3):
            ...
            for compute_node in FAKE_COMPUTE_NODES:
                fake_compute = compute.ComputeNode(**compute_node)
    ...
    def test_compute_node_get(self):
        fake_cell = 'fake-cell'
        fake_compute = compute.ComputeNode(**FAKE_COMPUTE_NODES[0])
        fake_compute._cached_service = None
        fake_response = messaging.Response(self.ctxt, fake_cell,
                                           fake_compute,
                                           False)
    ...
    def test_validate_console_port(self):
        instance_uuid = 'fake-instance-uuid'
        cell_name = 'fake-cell-name'
        instance = compute.Instance(cell_name=cell_name)
        ...
        compute.Instance.get_by_uuid(self.ctxt,

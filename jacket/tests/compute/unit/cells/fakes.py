...
from jacket.compute.cells import driver
from jacket.compute.cells import manager as cells_manager
...
class FakeDBApi(object):
    ...
    def __getattr__(self, key):
        return getattr(jacket.db.compute, key)
...
class CellStubInfo(object):
    def __init__(self, test_case, cell_name, db_entries):
        ...
        test_case.stubs.Set(compute.ComputeNodeList, 'get_all',
                            _fake_compute_node_get_all)
        test_case.stubs.Set(compute.ServiceList, 'get_by_binary',
...
def init(test_case):
    ...
    test_case.flags(driver='compute.tests.unit.cells.fakes.FakeCellsDriver',
            group='cells')
    CELL_NAME_TO_STUB_INFO = {}

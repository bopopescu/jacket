...
class ImagePropertiesFilter(_FilterTestClass):
    filter_cls_name = \
        'compute.cells.filters.image_properties.ImagePropertiesFilter'
...
class TestTargetCellFilter(_FilterTestClass):
    filter_cls_name = 'compute.cells.filters.target_cell.TargetCellFilter'
...
class TestDifferentCellFilter(_FilterTestClass):
    filter_cls_name = 'compute.cells.filters.different_cell.DifferentCellFilter'

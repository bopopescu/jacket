...
from jacket.db.compute.sqlalchemy import migrate_repo
from jacket.db.compute.sqlalchemy import migration as sa_migration
...
class NovaMigrationsCheckers(test_migrations.ModelsMigrationsSync,
    ...
    def setUp(self):
        ...
        # case and compute base test case cleanup must be the last one (as it
...
class ProjectTestCase(test.NoDBTestCase):
    ...
    def test_no_migrations_have_downgrade(self):
        ...
        py_glob = os.path.join(topdir, "compute", "db", "sqlalchemy",

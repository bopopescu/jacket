...
from jacket.tests.compute.unit import fake_build_request
    ...
    def test_get_by_uuid(self):
        ...
        for key in self.build_req_obj.fields.keys():
            ...
            if key == 'request_spec':
                ...
                # compute, so serialize them to a comparable form.
                db_value = jsonutils.dumps(compute.RequestSpec._from_db_object(
                    self.context, compute.RequestSpec(),

...
class ServerGroupTestV2(ServerGroupTestBase):
    ...
    def test_evacuate_with_anti_affinity(self):
        ...
        # compute considers the host down
...
class ServerGroupAffinityConfTest(ServerGroupTestBase):
    ...
    @mock.patch('compute.scheduler.utils._SUPPORTS_AFFINITY', None)
...
class ServerGroupAntiAffinityConfTest(ServerGroupTestBase):
    ...
    @mock.patch('compute.scheduler.utils._SUPPORTS_ANTI_AFFINITY', None)
...
class ServerGroupSoftAffinityConfTest(ServerGroupTestBase):
    ...
    def _get_weight_classes(self):
        ...
        return ['compute.scheduler.weights.affinity.'
                'ServerGroupSoftAntiAffinityWeigher']

    @mock.patch('jacket.compute._SUPPORTS_SOFT_AFFINITY', None)
...
class ServerGroupSoftAntiAffinityConfTest(ServerGroupTestBase):
    ...
    _scheduler_weight_classes = ['compute.scheduler.weights.affinity.'
    ...
    @mock.patch('compute.scheduler.utils._SUPPORTS_SOFT_ANTI_AFFINITY', None)
...
class ServerGroupTestV215(ServerGroupTestV2):
    ...
    def setUp(self):
        ...
        soft_affinity_patcher = mock.patch(
            'compute.scheduler.utils._SUPPORTS_SOFT_AFFINITY')
        soft_anti_affinity_patcher = mock.patch(
            'jacket.compute._SUPPORTS_SOFT_ANTI_AFFINITY')

...
from jacket.tests.compute.unit.api.openstack.compute import test_networks
...
class NetworksJsonTests(api_sample_base.ApiSampleTestBaseV21):
    ...
    def setUp(self):
        ...
        self.stub_out("compute.network.api.API.get_all", fake_network_api.get_all)
        self.stub_out("compute.network.api.API.get", fake_network_api.get)
        self.stub_out("compute.network.api.API.associate",
                      fake_network_api.associate)
        self.stub_out("compute.network.api.API.delete", fake_network_api.delete)
        self.stub_out("compute.network.api.API.create", fake_network_api.create)
        self.stub_out("compute.network.api.API.add_network_to_project",

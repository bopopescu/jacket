...
from jacket.tests.compute.unit.api.openstack.compute import test_services
...
class ServicesJsonTest(api_sample_base.ApiSampleTestBaseV21):
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.services.Services')
    ...
    def setUp(self):
        ...
        self.stub_out("compute.db.service_get_all",

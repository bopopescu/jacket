...
class EvacuateJsonTest(test_servers.ServersSampleBase):
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.evacuate.Evacuate')
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.extended_evacuate_find_host.'
    ...
    def _test_evacuate(self, req_subs, server_req, server_resp,
        ...
        self.stub_out(
            'compute.servicegroup.api.API.service_is_up',
            fake_service_is_up)
        self.stub_out(
            'compute.compute.api.HostAPI.service_get_by_compute_host',
            fake_service_get_by_compute_host)
        self.stub_out(
            'compute.compute.manager.ComputeManager._check_instance_exists',
    ...
    @mock.patch('compute.conductor.manager.ComputeTaskManager.rebuild_instance')

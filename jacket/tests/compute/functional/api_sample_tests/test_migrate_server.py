...
class MigrateServerSamplesJsonTest(test_servers.ServersSampleBase):
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.admin_actions.'
            'Admin_actions')
        return f
    ...
    @mock.patch('compute.conductor.manager.ComputeTaskManager._cold_migrate')
    ...
    def test_post_live_migrate_server(self):
        ...
        self.stub_out(
            'compute.conductor.manager.ComputeTaskManager._live_migrate',
            fake_live_migrate)
        ...
        self.stub_out("compute.db.service_get_by_compute_host", fake_get_compute)

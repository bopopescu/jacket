...
class AgentsJsonTest(api_sample_base.ApiSampleTestBaseV21):
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.agents.Agents')
        return f
    ...
    def setUp(self):
        ...
        self.stub_out("compute.db.agent_build_create", fake_agent_build_create)
        self.stub_out("compute.db.agent_build_get_all", fake_agent_build_get_all)
        self.stub_out("compute.db.agent_build_update", fake_agent_build_update)
        self.stub_out("compute.db.agent_build_destroy", fake_agent_build_destroy)

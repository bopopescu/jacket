...
import jacket.tests.compute.functional.api_samples_test_base as astb
...
class SecurityGroupsJsonTest(test_servers.ServersSampleBase):
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.security_groups.'
            'Security_groups')
        f['osapi_compute_extension'].append(
    ...
    def setUp(self):
        ...
        path = 'compute.network.security_group.neutron_driver.SecurityGroupAPI.'

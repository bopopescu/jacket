...
from jacket.api.compute.openstack import API_V21_CORE_EXTENSIONS  # noqa
from jacket.compute import test
from jacket.tests.compute.functional import api_paste_fixture
from jacket.tests.compute.functional import api_samples_test_base
from jacket.tests.compute.unit import fake_network
from jacket.tests.compute.unit import fake_utils

CONF = cfg.CONF
CONF.import_opt('osapi_compute_link_prefix', 'compute.api.openstack.common')

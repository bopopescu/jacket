...
class SnapshotsSampleJsonTests(api_sample_base.ApiSampleTestBaseV21):
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.volumes.Volumes')
        return f

    def setUp(self):
        super(SnapshotsSampleJsonTests, self).setUp()
        self.stub_out("compute.volume.cinder.API.get_all_snapshots",
                      fakes.stub_snapshot_get_all)
        self.stub_out("compute.volume.cinder.API.get_snapshot",
                      fakes.stub_snapshot_get)

    def _create_snapshot(self):
        self.stub_out("compute.volume.cinder.API.create_snapshot",
    ...
    def test_snapshots_delete(self):
        self.stub_out("compute.volume.cinder.API.delete_snapshot",
...
class VolumesSampleJsonTest(test_servers.ServersSampleBase):
    ...
    def setUp(self):
        ...
        self.stub_out("compute.volume.cinder.API.delete",
                      self._stub_volume_delete)
        self.stub_out("compute.volume.cinder.API.get", self._stub_volume_get)
        self.stub_out("compute.volume.cinder.API.get_all",
    ...
    def _post_volume(self):
        ...
        self.stub_out("compute.volume.cinder.API.create",
...
class VolumeAttachmentsSample(test_servers.ServersSampleBase):
    ...
    def _stub_db_bdms_get_all_by_instance(self, server_id):
        ...
        self.stub_out('compute.db.block_device_mapping_get_all_by_instance',
    ...
    def _stub_compute_api_get(self):
        ...
        self.stub_out('compute.compute.api.API.get', fake_compute_api_get)
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.volumes.Volumes')
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.'
    ...
    def test_volume_attachment_delete(self):
        ...
        self._stub_compute_api_get()
        self.stub_out('compute.volume.cinder.API.get', fakes.stub_volume_get)
        self.stub_out('compute.compute.api.API.detach_volume',
                      lambda *a, **k: None)
    ...
    def test_volume_attachment_update(self):
        ...
        self._stub_compute_api_get()
        self.stub_out('compute.volume.cinder.API.get', fakes.stub_volume_get)
        self.stub_out('compute.compute.api.API.swap_volume',
                      lambda *a, **k: None)

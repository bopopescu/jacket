...
from jacket.tests.compute.unit.api.openstack.compute import test_fping
...
class FpingSampleJsonTests(test_servers.ServersSampleBase):
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.fping.Fping')
        return f
    ...
    def setUp(self):
        ...
        def fake_check_fping(self):
            pass
        self.stub_out("compute.utils.execute", test_fping.execute)
        self.stub_out("compute.api.openstack.compute.fping."
                      "FpingController.check_fping",
                      fake_check_fping)
        self.stub_out("compute.api.openstack.compute.legacy_v2.contrib.fping."
                      "FpingController.check_fping",
                      fake_check_fping)

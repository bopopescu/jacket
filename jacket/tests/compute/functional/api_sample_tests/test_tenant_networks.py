...
class TenantNetworksJsonTests(api_sample_base.ApiSampleTestBaseV21):
    ...
    def setUp(self):
        ...
        self.stub_out("compute.quota.QUOTAS.reserve", fake)
        self.stub_out("compute.quota.QUOTAS.commit", fake)
        self.stub_out("compute.quota.QUOTAS.rollback", fake)
        self.stub_out("compute.quota.QuotaEngine.reserve", fake)
        self.stub_out("compute.quota.QuotaEngine.commit", fake)
        self.stub_out("compute.quota.QuotaEngine.rollback", fake)

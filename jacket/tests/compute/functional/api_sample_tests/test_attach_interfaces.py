...
class AttachInterfacesSampleJsonTest(test_servers.ServersSampleBase):
    ...
    def setUp(self):
        ...
        self.stub_out('compute.network.api.API.list_ports', fake_list_ports)
        self.stub_out('compute.network.api.API.show_port', fake_show_port)
        self.stub_out('compute.compute.api.API.attach_interface',
                      fake_attach_interface)
        self.stub_out('compute.compute.api.API.detach_interface',
    ...
    def _stub_show_for_instance(self, instance_uuid, port_id):
        ...
        self.stub_out('compute.network.api.API.show_port',

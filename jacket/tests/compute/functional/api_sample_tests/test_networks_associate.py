...
class NetworksAssociateJsonTests(api_sample_base.ApiSampleTestBaseV21):
    ...
    def _get_flags(self):
        ...
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.os_networks.Os_networks')
        f['osapi_compute_extension'].append(
            'compute.api.openstack.compute.contrib.networks_associate.'
            'Networks_associate')
        return f
    ...
    def setUp(self):
        ...
        self.stub_out("compute.network.api.API.associate", fake_associate)

...
CONF = cfg.CONF
CONF.import_opt('vpn_image_id', 'compute.cloudpipe.pipelib')
...
class CloudPipeSampleTest(api_sample_base.ApiSampleTestBaseV21):
    ...
    def setUp(self):
        ...
        self.stub_out('compute.cloudpipe.pipelib.CloudPipe.get_encoded_zip',
                      get_user_data)
        self.stub_out('compute.network.api.API.get',
                      network_api_get)

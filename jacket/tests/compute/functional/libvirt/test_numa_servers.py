...
from jacket.tests.compute.functional.test_servers import ServersTestBase
...
class NUMAServersTest(ServersTestBase):
    ...
    def setUp(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
           ...
           fakelibvirt))
        self.useFixture(fixtures.MonkeyPatch(
           'compute.virt.libvirt.guest.libvirt',
           fakelibvirt))
    ...
    def _setup_scheduler_service(self):
        self.flags(compute_driver='compute.virt.libvirt.LibvirtDriver')
    ...
    @mock.patch('compute.virt.libvirt.LibvirtDriver._create_image')
    def test_create_server_with_numa_topology(self, img_mock):
        ...
        with test.nested(
            mock.patch('compute.virt.libvirt.host.Host.get_connection',
                       return_value=fake_connection),
            mock.patch('compute.scheduler.filters'

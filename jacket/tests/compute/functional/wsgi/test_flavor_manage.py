...
from jacket.compute import exception as ex
from jacket.compute import test
from jacket.tests.compute import fixtures as nova_fixtures
from jacket.tests.compute.functional import integrated_helpers as helper
...
class FlavorManageFullstack(test.TestCase):
    ...
    This test starts the wsgi stack for the compute api services, uses an
    ...
    def assertFlavorDbEqual(self, flav, flavdb):
        # a mapping of the REST params to the compute fields
        mapping = {
            'name': 'name',
            'disk': 'root_gb',
            'ram': 'memory_mb',
    ...
    def test_flavor_manage_func_negative(self):
        ...
        # ... and ensure that we didn't leak it into the compute

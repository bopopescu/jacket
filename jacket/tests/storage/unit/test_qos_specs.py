...
class QoSSpecsTestCase(test.TestCase):
    ...
    def test_create(self):
        ...
        self.stubs.Set(storage, 'qos_specs_create',
    ...
    def test_update(self):
        ...
        self.stubs.Set(storage, 'qos_specs_update', fake_db_update)
    ...
    def test_delete(self):
        ...
        self.stubs.Set(storage, 'qos_specs_associations_get',
                       fake_db_associations_get)
        self.stubs.Set(qos_specs, 'disassociate_all',
                       fake_disassociate_all)
        self.stubs.Set(storage, 'qos_specs_delete', fake_db_delete)
        self.assertRaises(exception.InvalidQoSSpecs,
    ...
    def test_delete_keys(self):
        ...
        self.stubs.Set(storage, 'qos_specs_item_delete', fake_db_qos_delete_key)
        self.assertRaises(exception.InvalidQoSSpecs,
    ...
    def test_associate_qos_with_type(self):
        ...
        self.stubs.Set(storage, 'qos_specs_associate',
                       fake_db_associate)
        self.stubs.Set(qos_specs, 'get_qos_specs', fake_qos_specs_get)
    ...
    def test_disassociate_qos_specs(self):
        ...
        self.stubs.Set(storage, 'qos_specs_disassociate',
    ...
    def test_disassociate_all(self):
        ...
        self.stubs.Set(storage, 'qos_specs_disassociate_all',

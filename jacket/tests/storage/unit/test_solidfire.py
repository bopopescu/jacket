...
from jacket.storage.volume.drivers import solidfire
...
class SolidFireVolumeTestCase(test.TestCase):
    def setUp(self):
        ...
        self.configuration.sf_account_prefix = 'storage'
    ...
    def test_accept_transfer(self):
        ...
        testvol = {'project_id': 'testprjid',
                   ...
                   'id': 'a720b3c0-d1f0-11e1-9b23-0800200c9a66',
                   'created_at': timeutils.utcnow()}
        expected = {'provider_auth': 'CHAP storage-new_project 123456789012'}

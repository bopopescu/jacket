...
from jacket.tests.storage.unit.backup import fake_google_client
from jacket.tests.storage.unit.backup import fake_google_client2
...
class GoogleBackupDriverTestCase(test.TestCase):
    ...
    @gcs_client
    @mock.patch('storage.backup.drivers.google.GoogleBackupDriver.'
                '_send_progress_end')
    @mock.patch('storage.backup.drivers.google.GoogleBackupDriver.'

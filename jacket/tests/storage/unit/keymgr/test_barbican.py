...
from jacket.storage.keymgr import barbican
...
class BarbicanKeyManagerTestCase(test_key_mgr.KeyManagerTestCase):
    ...
    @mock.patch('storage.keymgr.barbican.identity.v3.Token')
    @mock.patch('storage.keymgr.barbican.session.Session')
    @mock.patch('storage.keymgr.barbican.barbican_client.Client')

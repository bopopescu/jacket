...
class volumeMetaDataTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(storage, 'volume_metadata_get',
    ...
    @mock.patch.object(storage, 'volume_metadata_delete')
    @mock.patch.object(storage, 'volume_metadata_get')
    ...
    @mock.patch.object(storage, 'volume_metadata_update')
    @mock.patch.object(storage, 'volume_metadata_get')
    ...
    def test_update_all_nonexistent_volume(self):
        self.stubs.Set(storage, 'volume_get', return_volume_nonexistent)
        req = fakes.HTTPRequest.blank(self.url)
        req.method = 'PUT'
        req.content_type = "application/json"
    ...
    def test_update_item_nonexistent_volume(self):
        self.stubs.Set(storage, 'volume_get',
                       return_volume_nonexistent)

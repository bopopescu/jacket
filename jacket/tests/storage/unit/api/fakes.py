...
from jacket.api.storage.storage.middleware import auth
from jacket.api.storage.storage.middleware import fault
from jacket.api.storage.storage.openstack import api_version_request as api_version
from jacket.api.storage.storage.openstack import wsgi as os_wsgi
...
class HTTPRequest(webob.Request):
    ...
    def blank(cls, *args, **kwargs):
        ...
        out.environ['storage.context'] = FakeRequestContext(
            'fake_user',
            'fakeproject',

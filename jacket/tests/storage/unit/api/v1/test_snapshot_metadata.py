...
from jacket.api.storage.storage.v1 import snapshot_metadata
...
class SnapshotMetaDataTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(jacket.db.storage, 'snapshot_get', return_snapshot)
    ...
    def test_delete_nonexistent_snapshot(self):
        self.stubs.Set(jacket.db.storage, 'snapshot_get',
    ...
    def test_create(self, snapshot_get_by_id, volume_get_by_id,
        ...
        self.stubs.Set(jacket.db.storage, 'snapshot_metadata_update',
    ...
    @mock.patch('jacket.storage.snapshot_update')
    @mock.patch('storage.objects.Snapshot.get_by_id')
    ...
    @mock.patch('storage.snapshot_update',
    ...
    @mock.patch('storage.db.sqlalchemy.api._snapshot_get')
    @mock.patch('storage.db.snapshot_metadata_update', autospec=True)
    ...
    def test_update_all_nonexistent_snapshot(self):
        self.stubs.Set(jacket.db.storage, 'snapshot_get', return_snapshot_nonexistent)
        req = fakes.HTTPRequest.blank(self.url)
        req.method = 'PUT'
        req.content_type = "application/json"
    ...
    @mock.patch('storage.snapshot_metadata_update', return_value=dict())
    @mock.patch('storage.db.snapshot_update')
    @mock.patch('storage.objects.Snapshot.get_by_id')
    ...
    @mock.patch('storage.db.sqlalchemy.api._snapshot_get')
    @mock.patch('jacket.storage.snapshot_metadata_update', autospec=True)

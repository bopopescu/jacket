...
import jacket.storage.transfer
...
class VolumeTransferAPITestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.volume_transfer_api = jacket.storage.transfer.API()
    ...
    def _create_volume(display_name='test_volume',
        ...
        return storage.volume_create(context.get_admin_context(), vol)['id']
    ...
    def test_show_transfer(self):
        ...
        storage.transfer_destroy(context.get_admin_context(), transfer['id'])
    ...
    def test_list_transfers_json(self):
        ...
        storage.transfer_destroy(context.get_admin_context(), transfer2['id'])
        storage.transfer_destroy(context.get_admin_context(), transfer1['id'])
        storage.volume_destroy(context.get_admin_context(), volume_id_1)
        storage.volume_destroy(context.get_admin_context(), volume_id_2)
    ...
    def test_delete_transfer_awaiting_transfer(self):
        ...
        self.assertEqual('Transfer %s could not be found.' % transfer['id'],
                         res_dict['itemNotFound']['message'])
        self.assertEqual(storage.volume_get(context.get_admin_context(),
    ...
    def test_accept_transfer_with_VolumeLimitExceeded(self):
        ...
        self.stubs.Set(jacket.storage.transfer.API, 'accept',

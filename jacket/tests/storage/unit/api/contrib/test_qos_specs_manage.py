...
class QoSSpecManageApiTest(test.TestCase):
    ...
    @mock.patch('storage.volume.qos_specs.get_all_specs',
    ...
    @mock.patch('storage.volume.qos_specs.get_qos_specs',
                side_effect=return_qos_specs_get_qos_specs)
    @mock.patch('storage.volume.qos_specs.delete',
    ...
    def test_qos_specs_delete(self, mock_qos_delete, mock_qos_get_specs):
        ...
        with mock.patch('storage.rpc.get_notifier', return_value=notifier):
    ...
    @mock.patch('storage.volume.qos_specs.delete_keys',
    ...
    @mock.patch('storage.volume.qos_specs.create',
                side_effect=return_qos_specs_create)
    @mock.patch('storage.volume.qos_specs.get_qos_specs_by_name',
                side_effect=return_qos_specs_get_by_name)
    @mock.patch('storage.api.storage.openstack.wsgi.Controller.validate_string_length')
    ...
    @mock.patch('storage.volume.qos_specs.update',
    ...
    @mock.patch('storage.volume.qos_specs.get_associations',
    ...
    @mock.patch('storage.volume.qos_specs.get_qos_specs',
                side_effect=return_qos_specs_get_qos_specs)
    @mock.patch('storage.volume.qos_specs.associate_qos_with_type',
    ...
    @mock.patch('storage.volume.qos_specs.get_qos_specs',
                side_effect=return_qos_specs_get_qos_specs)
    @mock.patch('storage.volume.qos_specs.disassociate_qos_specs',
                side_effect=return_associate_qos_specs)
    ...
    @mock.patch('storage.volume.qos_specs.get_qos_specs',
                side_effect=return_qos_specs_get_qos_specs)
    @mock.patch('storage.volume.qos_specs.disassociate_all',

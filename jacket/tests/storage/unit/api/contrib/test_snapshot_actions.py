...
class SnapshotActionsTest(test.TestCase):
    ...
    @mock.patch('storage.storage.snapshot_update', autospec=True)
    @mock.patch('storage.storage.sqlalchemy.api._snapshot_get',
    ...
    def test_update_snapshot_status_without_status(self):
        self.stubs.Set(storage, 'snapshot_get', stub_snapshot_get)

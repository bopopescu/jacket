...
class VolumeEncryptionMetadataTest(test.TestCase):
    ...
    def _create_volume(context,
        ...
        return storage.volume_create(context, volume)['id']
    ...
    def setUp(self):
        ...
        self.stubs.Set(storage.sqlalchemy.api, 'volume_type_encryption_get',
                       return_volume_type_encryption_metadata)

        self.ctxt = context.RequestContext('fake', 'fake')
        self.volume_id = self._create_volume(self.ctxt)
        self.addCleanup(storage.volume_destroy, self.ctxt.elevated(),
                        self.volume_id)
    ...
    def test_show_volume_not_encrypted_type(self):
        ...
        self.addCleanup(storage.volume_destroy, self.ctxt.elevated(), volume_id)

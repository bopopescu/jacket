...
class ConsistencyGroupsAPITestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.cg_api = jacket.storage.consistencygroup.API()
    ...
    def _create_consistencygroup(
        ...
        consistencygroup = storage.ConsistencyGroup(ctxt)
    ...
    def test_create_consistencygroup_json(self, mock_validate):
        ...
        cg = storage.ConsistencyGroup.get_by_id(context.get_admin_context(),
                                                group_id)
        cg.destroy()
    ...
    def test_create_delete_consistencygroup_update_quota(self):
        ...
        self.stubs.Set(storage, 'volume_types_get_by_name_or_id',
    ...
    def test_update_consistencygroup_success(self, mock_validate):
        ...
        cg_volumes = storage.volume_get_all_by_group(self.ctxt.elevated(),
                                                consistencygroup.id)
    ...
    def test_create_consistencygroup_from_src(self, mock_validate):
        ...
        cg_ref = storage.ConsistencyGroup.get_by_id(
            self.ctxt.elevated(), res_dict['consistencygroup']['id'])

        cg_ref.destroy()
        snapshot.destroy()
        storage.volume_destroy(self.ctxt.elevated(), volume_id)
        consistencygroup.destroy()
        cgsnapshot.destroy()
    ...
    def test_create_consistencygroup_from_src_both_snap_cg(self):
        ...
        snapshot.destroy()
        storage.cgsnapshot_destroy(self.ctxt.elevated(), cgsnapshot_id)
        storage.volume_destroy(self.ctxt.elevated(), volume_id)
        consistencygroup.destroy()

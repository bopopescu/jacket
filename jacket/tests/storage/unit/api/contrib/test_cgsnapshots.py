...
from jacket.storage.consistencygroup import api as consistencygroupAPI
...
class CgsnapshotsAPITestCase(test.TestCase):
    ...
    def test_show_cgsnapshot(self):
        ...
        cgsnapshot.destroy()
        storage.volume_destroy(context.get_admin_context(),
                          volume_id)
    ...
    @mock.patch.object(storage.CGSnapshot, 'create')

...
import jacket.api.storage.storage.contrib.availability_zones
import jacket.storage.context
import jacket.storage.test
import jacket.storage.volume.api
...
class FakeRequest(object):
    environ = {'storage': jacket.storage.context.get_admin_context()}
    GET = {}


class ControllerTestCase(jacket.storage.test.TestCase):

    def setUp(self):
        super(ControllerTestCase, self).setUp()
        self.controller = jacket.api.storage.storage.contrib.availability_zones.Controller()
        self.req = FakeRequest()
        self.stubs.Set(jacket.storage.volume.api.API,
...
class XMLSerializerTest(jacket.storage.test.TestCase):
    ...
    def test_index_xml(self):
        ...
        serializer = jacket.api.storage.storage.contrib.availability_zones.ListTemplate()

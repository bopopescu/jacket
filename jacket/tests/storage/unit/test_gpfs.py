...
from jacket.storage.volume.drivers.ibm import gpfs
...
class GPFSDriverTestCase(test.TestCase):
    driver_name = "storage.volume.drivers.gpfs.GPFSDriver"
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._get_gpfs_state')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._verify_gpfs_pool')
    @mock.patch('storage.utils.execute')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._check_gpfs_state')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._is_gpfs_path')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
    ...
    def test_check_for_setup_error_fail_conf(self,
        ...
        with mock.patch('storage.volume.drivers.ibm.gpfs._same_filesystem',
                        return_value=False):
            self.assertRaises(exception.VolumeBackendAPIException,
                              self.driver.check_for_setup_error)
        self.flags(volume_driver=self.driver_name,
        ...
        self.flags(volume_driver=self.driver_name,
                   gpfs_images_share_mode='copy_on_write')
        with mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._mkfs')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
                '_create_sparse_file')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.local_path')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
                '_set_volume_attributes')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._gpfs_redirect')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
                '_set_rw_permission')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._create_gpfs_copy')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._gpfs_full_copy')
    @mock.patch('storage.volume.drivers.ibm.gpfs.'
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._delete_gpfs_file')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.local_path')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
                '_verify_gpfs_path_state')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._create_gpfs_snap')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._create_gpfs_copy')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._gpfs_redirect')
    @mock.patch('storage.utils.execute')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._clone_image')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.local_path')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._is_cloneable')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
                '_verify_gpfs_path_state')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
                '_resize_volume_file')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.local_path')
    @mock.patch('storage.image.image_utils.fetch_to_raw')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.'
                '_verify_gpfs_path_state')
    ...
    @mock.patch('storage.image.image_utils.qemu_img_info')
    @mock.patch('storage.image.image_utils.resize_image')
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.local_path')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.local_path')
    @mock.patch('storage.image.image_utils.upload_volume')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver._migrate_volume')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs._different')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.create_snapshot')
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSDriver.delete_snapshot')
...
class GPFSNFSDriverTestCase(test.TestCase):
    driver_name = "storage.volume.drivers.gpfs.GPFSNFSDriver"
    ...
    @mock.patch('storage.volume.drivers.ibm.gpfs.GPFSNFSDriver.'
                '_run_ssh')
    ...
    def test_update_volume_stats(self, mock_ensure):
        ...
        with mock.patch('storage.volume.drivers.ibm.gpfs.GPFSNFSDriver.'
                        '_get_capacity_info',

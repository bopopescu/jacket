...
from jacket.storage.volume.drivers.emc import emc_vmax_fc
from jacket.storage.volume.drivers.emc import emc_vmax_iscsi
...
CINDER_EMC_CONFIG_DIR = '/etc/storage/'
...
class EMCVMAXISCSIDriverNoFastTestCase(test.TestCase):
    ...
    # fix for https://bugs.launchpad.net/storage/+bug/1364232
    ...
    # Bug https://bugs.launchpad.net/storage/+bug/1440154
    @mock.patch.object(
        emc_vmax_utils.EMCVMAXUtils,
        'get_volume_meta_head',
        return_value=[EMCVMAXCommonData.test_volume])
    ...
    # Bug https://bugs.launchpad.net/storage/+bug/1442376
    @mock.patch.object(
        emc_vmax_common.EMCVMAXCommon,
        '_get_pool_and_storage_system',
        return_value=(None, EMCVMAXCommonData.storage_system))

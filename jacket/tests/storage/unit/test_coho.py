...
from jacket.storage.volume.drivers import coho
from jacket.storage.volume.drivers import nfs

ADDR = 'coho-datastream-addr'
PATH = '/test/path'
RPC_PORT = 2049
LOCAL_PATH = '/opt/storage/mnt/test/path'
...
class CohoDriverTest(test.TestCase):
    ...
    def setUp(self):
        ...
        self.configuration.nfs_shares_config = '/etc/storage/coho_shares'
        self.configuration.nfs_sparsed_volumes = True
        self.configuration.nfs_mount_point_base = '/opt/stack/storage/mnt'

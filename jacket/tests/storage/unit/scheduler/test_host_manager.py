...
from jacket.storage.scheduler import host_manager
from jacket.storage import test
from jacket.tests.storage.unit.objects import test_service
...
class HostManagerTestCase(test.TestCase):
    ...
    def test_get_all_host_states(self, _mock_service_is_up,
        ...
        for db_service in services:
            service_obj = storage.Service()
            service_objs.append(storage.Service._from_db_object(context,
                                                                service_obj,
                                                                db_service))

...
class TestBlockDeviceDriver(jacket.storage.test.TestCase):
    ...
    @mock.patch('storage.volume.driver.ISCSIDriver.initialize_connection')
    ...
    @mock.patch('storage.volume.drivers.block_device.BlockDeviceDriver.'
                'local_path', return_value=None)
    @mock.patch('storage.volume.utils.clear_volume')
    ...
    @mock.patch('storage.volume.utils.copy_volume')
    ...
    @mock.patch.object(jacket.storage.image.image_utils, 'fetch_to_raw')
    ...
    def test_copy_volume_to_image(self):
        ...
        with mock.patch.object(jacket.storage.image.image_utils, 'upload_volume') as \
                _upload_volume:
    ...
    def test_find_appropriate_size_device_no_free_disks(self):
        ...
        with mock.patch.object(self.drv, '_devices_sizes') as _dvc_sizes:
            with mock.patch.object(self.drv, '_get_used_devices') as \
                ...
                self.assertRaises(jacket.storage.exception.CinderException,

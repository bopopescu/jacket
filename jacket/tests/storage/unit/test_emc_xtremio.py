...
from jacket.tests.storage.unit import fake_consistencygroup as fake_cg
from jacket.tests.storage.unit import fake_snapshot
from jacket.tests.storage.unit import fake_volume
from jacket.storage.volume.drivers.emc import xtremio
...
@mock.patch('storage.volume.drivers.emc.xtremio.XtremIOClient.req')
class EMCXIODriverISCSITestCase(test.TestCase):
    ...
    @mock.patch('storage.objects.snapshot.SnapshotList.get_all_for_cgsnapshot')

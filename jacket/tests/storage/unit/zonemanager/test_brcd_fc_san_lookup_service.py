...
import jacket.storage.zonemanager.drivers.brocade.brcd_fc_san_lookup_service as brcd_lookup
    as brcd_lookup
...
class TestBrcdFCSanLookupService(brcd_lookup.BrcdFCSanLookupService,
    ...
    def setUp(self):
        ...
        self.configuration.brcd_sb_connector = ('jacket.tests.unit.zonemanager'
    ...
    def get_client(self, protocol='HTTPS'):
        conn = ('jacket.tests.unit.zonemanager.'

...
from jacket.storage.zonemanager.drivers.brocade import brcd_fc_zone_driver as driver
...
class BrcdFcZoneDriverBaseTest(object):
    ...
    def setup_config(self, is_normal, mode):
        ...
        configuration.zone_driver = ('storage.tests.unit.zonemanager.'
                                     'test_brcd_fc_zone_driver.'
                                     'FakeBrcdFCZoneDriver')
        configuration.brcd_sb_connector = ('storage.tests.unit.zonemanager.'
                                           'test_brcd_fc_zone_driver'
        ...
        configuration.fc_san_lookup_service = ('storage.tests.unit.zonemanager.'
                                               'test_brcd_fc_zone_driver.'
...
class TestBrcdFcZoneDriver(BrcdFcZoneDriverBaseTest, test.TestCase):
    ...
    def setup_driver(self, config):
        self.driver = importutils.import_object(
            'storage.zonemanager.drivers.brocade.brcd_fc_zone_driver'
    ...
    def get_client(self, protocol='HTTPS'):
        conn = ('storage.tests.unit.zonemanager.test_brcd_fc_zone_driver.' +

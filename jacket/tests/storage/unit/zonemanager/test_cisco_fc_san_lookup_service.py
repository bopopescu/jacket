...
import jacket.storage.zonemanager.drivers.cisco.cisco_fc_san_lookup_service as cisco_lookup
    as cisco_lookup
import jacket.zonemanager.drivers.cisco.fc_zone_constants as ZoneConstant
from jacket.zonemanager import utils as zm_utils

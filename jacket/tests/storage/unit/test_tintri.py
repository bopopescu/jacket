...
from jacket.storage.volume.drivers.tintri import TClient
from jacket.storage.volume.drivers.tintri import TintriDriver
...
class TintriDriverTestCase(test.TestCase):
    ...
    def test_create_snapshot(self):
        ...
        with mock.patch('storage.objects.snapshot.Snapshot.save'):

...
class VolumeTypeExtraSpecsTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        ref = storage.volume_type_create(self.context, self.vol_type1)
        ...
        ref = storage.volume_type_create(self.context, self.vol_type2_noextra)
        self.addCleanup(storage.volume_type_destroy, context.get_admin_context(),
    ...
    def test_volume_type_get_all(self):
        ...
        types = storage.volume_type_get_all(context.get_admin_context())

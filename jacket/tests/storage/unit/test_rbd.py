...
def common_mocks(f):
    ...
    def _common_inner_inner1(inst, *args, **kwargs):
        ...
        @mock.patch('storage.volume.drivers.rbd.RBDVolumeProxy')
        @mock.patch('storage.volume.drivers.rbd.RADOSClient')
...
class RBDTestCase(test.TestCase):
    ...
    def test_min_config(self, cluster_name, pool_name):
        ...
        with mock.patch('storage.volume.drivers.rbd.rados'):
    ...
    def test_copy_image_volume_tmp(self):
        self.cfg.volume_tmp_dir = None
        self.cfg.image_conversion_dir = '/var/run/storage/tmp'
        self._copy_image()
    ...
    def test_update_volume_stats(self):
        ...
        client.cluster.mon_command.return_value = (
            ...
            '"bytes_used":1546440971,"max_avail":28987613184,"storage":412}},'
            '{"name":"volumes","id":3,"stats":{"kb_used":0,"bytes_used":0,'
            '"max_avail":28987613184,"storage":0}}]}\n', '')
...
class ManagedRBDTestCase(test_volume.DriverTestCase):
    driver_name = "storage.volume.drivers.rbd.RBDDriver"
    ...
    def _create_volume_from_image(self, expected_status, raw=False,
        ...
        db_volume = {'display_description': 'Test Desc',
                     ...
                     'host': 'dummy'}
        volume = storage.Volume(context=self.context, **db_volume)
        volume.create()
    ...
    @mock.patch.object(jacket.storage.image.glance, 'get_default_image_service')

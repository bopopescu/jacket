...
from jacket.tests.storage.unit import fake_hpe_3par_client as hpe3parclient
from jacket.storage.volume.drivers.hpe import hpe_3par_common as hpecommon
from jacket.storage.volume.drivers.hpe import hpe_3par_fc as hpefcdriver
from jacket.storage.volume.drivers.hpe import hpe_3par_iscsi as hpedriver
...
CHAP_USER_KEY = "HPQ-storage-CHAP-name"
CHAP_PASS_KEY = "HPQ-storage-CHAP-secret"
...
class TestHPE3PARFCDriver(HPE3PARBaseDriver, test.TestCase):
    ...
    @mock.patch('storage.zonemanager.utils.create_lookup_service')

...
from jacket.storage.volume.targets import iet
...
class TestIetAdmDriver(tf.TargetDriverFixture):
    ...
    @mock.patch('storage.volume.targets.iet.IetAdm._get_target',
                return_value=0)
    ...
    @mock.patch('storage.volume.targets.iet.IetAdm._find_sid_cid_for_target',
                return_value=None)
    ...
    @mock.patch('storage.volume.targets.iet.IetAdm._get_target_chap_auth',
                return_value=None)
    @mock.patch('storage.volume.targets.iet.IetAdm._get_target',
                return_value=1)

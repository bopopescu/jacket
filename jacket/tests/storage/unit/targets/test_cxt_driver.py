...
class TestCxtAdmDriver(tf.TargetDriverFixture):
    ...
    @mock.patch('storage.volume.targets.cxt.CxtAdm._get_target',
                return_value=1)
    @mock.patch('storage.utils.execute')
    ...
    @mock.patch('storage.volume.targets.cxt.CxtAdm._get_target',
                return_value=1)
    @mock.patch('storage.utils.execute', return_value=('fake out', 'fake err'))
    ...
    @mock.patch('storage.volume.targets.cxt.CxtAdm._get_target_chap_auth')

...
class RPCAPITestCase(test.TestCase):
    ...
    @mock.patch('storage.objects.Service.get_minimum_rpc_version',
                return_value='1.2')
    @mock.patch('storage.objects.Service.get_minimum_obj_version',
                return_value='1.3')
    ...
    @mock.patch('storage.objects.Service.get_minimum_obj_version')
    @mock.patch('storage.rpc.get_client')
    @mock.patch('storage.rpc.LAST_RPC_VERSIONS', {'storage-scheduler': '1.4'})

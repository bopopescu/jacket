...
class ExecuteTestCase(test.TestCase):
    @mock.patch('storage.utils.processutils.execute')
...
class GenericUtilsTestCase(test.TestCase):
    ...
    @mock.patch('storage.utils.CONF')
    def test_get_root_helper(self, mock_conf):
        mock_conf.rootwrap_config = '/path/to/conf'
        self.assertEqual('sudo storage-rootwrap /path/to/conf',
...
class MonkeyPatchTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.example_package = 'storage.tests.unit.monkey_patch_example.'
        self.flags(
            monkey_patch=True,
    ...
    def test_monkey_patch(self):
        utils.monkey_patch()
        storage.tests.unit.monkey_patch_example.CALLED_FUNCTION = []
        from jacket.tests.storage.unit.monkey_patch_example import example_a
        from jacket.tests.storage.unit.monkey_patch_example import example_b
        ...
        self.assertTrue(
            ...
            in storage.tests.unit.monkey_patch_example.CALLED_FUNCTION)

...
class NotifyUsageTestCase(test.TestCase):
    @mock.patch('storage.volume.utils._usage_from_volume')
    @mock.patch('storage.volume.utils.CONF')
    @mock.patch('storage.volume.utils.rpc')
    ...
    @mock.patch('storage.volume.utils._usage_from_snapshot')
    @mock.patch('storage.volume.utils.CONF')
    @mock.patch('storage.volume.utils.rpc')
    ...
    @mock.patch('storage.objects.Volume.get_by_id')
    ...
    @mock.patch('storage.db.volume_attachment_get_used_by_volume_id')
    ...
    @mock.patch('storage.volume.utils._usage_from_consistencygroup')
    @mock.patch('storage.volume.utils.CONF')
    @mock.patch('storage.volume.utils.rpc')
    ...
    @mock.patch('storage.volume.utils._usage_from_cgsnapshot')
    @mock.patch('storage.volume.utils.CONF')
    @mock.patch('storage.volume.utils.rpc')
    ...
    def test_usage_from_backup(self):
        raw_backup = {
            ...
            'service': 'storage.backup.drivers.swift',
            'fail_reason': None,
...
class ClearVolumeTestCase(test.TestCase):
    @mock.patch('storage.volume.utils.copy_volume', return_value=None)
    @mock.patch('storage.volume.utils.CONF')
...
class CopyVolumeTestCase(test.TestCase):
    @mock.patch('storage.volume.utils._calculate_count',
    ...
    @mock.patch('storage.volume.utils._copy_volume_with_file')
    ...
    @mock.patch('storage.volume.utils._transfer_data')
    @mock.patch('storage.volume.utils._open_volume_with_path')
...
class VolumeUtilsTestCase(test.TestCase):
    ...
    @mock.patch('storage.utils.get_root_helper')
    ...
    @mock.patch('storage.utils.get_root_helper')
    @mock.patch('storage.brick.local_dev.lvm.LVM.get_all_volume_groups')
    ...
    @mock.patch('storage.volume.utils.generate_password')

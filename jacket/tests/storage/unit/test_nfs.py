...
class NfsDriverTestCase(test.TestCase):
    ...
    TEST_MNT_POINT_BASE_EXTRA_SLASH = '/opt/stack/data/storage//mnt'
    ...
    def test_get_mount_point_for_share_given_extra_slash_in_state_path(self):
        ...
        self.assertEqual('/opt/stack/data/storage/mnt', drv.base)

        self.assertEqual(
            '/opt/stack/data/storage/mnt/2f4f60214cf43c595666dd815f0360a4',
            drv._get_mount_point_for_share(self.TEST_NFS_EXPORT1))

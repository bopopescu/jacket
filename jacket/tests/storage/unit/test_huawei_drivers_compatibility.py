...
CONF = cfg.CONF
HUAWEI_ISCSI_MODULE = ("storage.volume.drivers.huawei.huawei_driver."
                       "HuaweiISCSIDriver")
HUAWEI_FC_MODULE = ("storage.volume.drivers.huawei.huawei_driver."
                    "HuaweiFCDriver")
...
class VolumeDriverCompatibility(test.TestCase):
    ...
    def test_huawei_driver_iscsi_old(self):
        self._load_driver(
            'storage.volume.drivers.huawei.huawei_driver.'

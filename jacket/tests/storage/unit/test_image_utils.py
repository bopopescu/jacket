...
class TestQemuImgInfo(test.TestCase):
    ...
    @mock.patch('storage.image.image_utils.os')
    @mock.patch('oslo_utils.imageutils.QemuImgInfo')
    @mock.patch('storage.utils.execute')
...
class TestConvertImage(test.TestCase):
    @mock.patch('storage.image.image_utils.qemu_img_info')
    @mock.patch('storage.utils.execute')
    @mock.patch('storage.utils.is_blk_device', return_value=True)
    def test_defaults_block_dev_with_size_info(self, mock_isblk,
        ...
        with mock.patch('storage.volume.utils.check_for_odirect_support',
                        return_value=True):
    ...
    @mock.patch('storage.volume.utils.check_for_odirect_support',
                return_value=True)
    @mock.patch('storage.image.image_utils.qemu_img_info')
    @mock.patch('storage.utils.execute')
    @mock.patch('storage.utils.is_blk_device', return_value=False)
...
class TestFetch(test.TestCase):
    @mock.patch('os.stat')
    @mock.patch('storage.image.image_utils.fileutils')
    def test_defaults(self, mock_fileutils, mock_stat):
        ...
        with mock.patch('storage.image.image_utils.open',
...
class TestVerifyImage(test.TestCase):
    @mock.patch('storage.image.image_utils.qemu_img_info')
    @mock.patch('storage.image.image_utils.fileutils')
    @mock.patch('storage.image.image_utils.fetch')
...
class TestTemporaryDir(test.TestCase):
    @mock.patch('storage.image.image_utils.CONF')
    @mock.patch('os.makedirs')
    @mock.patch('os.path.exists', return_value=True)
    @mock.patch('storage.image.image_utils.utils.tempdir')
...
class TestUploadVolume(test.TestCase):
    ...
    @mock.patch('storage.image.image_utils.qemu_img_info')
    @mock.patch('storage.image.image_utils.convert_image')
    @mock.patch('storage.image.image_utils.temporary_file')
    @mock.patch('storage.image.image_utils.os')
    ...
    @mock.patch('storage.image.image_utils.utils.temporary_chown')
    @mock.patch('storage.image.image_utils.CONF')
    @mock.patch('six.moves.builtins.open')
    @mock.patch('storage.image.image_utils.qemu_img_info')
    @mock.patch('storage.image.image_utils.convert_image')
...
class TestFetchToVhd(test.TestCase):
    @mock.patch('storage.image.image_utils.fetch_to_volume_format')
...
class TestFetchToVolumeFormat(test.TestCase):
    @mock.patch('storage.image.image_utils.convert_image')
    @mock.patch('storage.image.image_utils.volume_utils.copy_volume')
    @mock.patch(
        'storage.image.image_utils.replace_xenserver_image_with_coalesced_vhd')
    @mock.patch('storage.image.image_utils.is_xenserver_image',
                return_value=False)
    @mock.patch('storage.image.image_utils.fetch')
    @mock.patch('storage.image.image_utils.qemu_img_info')
    @mock.patch('storage.image.image_utils.temporary_file')
...
class TestXenserverUtils(test.TestCase):
    @mock.patch('storage.image.image_utils.is_xenserver_format')
    ...
    @mock.patch('storage.image.image_utils.utils.execute')
...
class TestVhdUtils(test.TestCase):
    ...
    @mock.patch('storage.image.image_utils.set_vhd_parent')
    ...
    @mock.patch('storage.image.image_utils.coalesce_vhd')
    @mock.patch('storage.image.image_utils.resize_vhd')
    @mock.patch('storage.image.image_utils.get_vhd_size')
    @mock.patch('storage.image.image_utils.utils.execute')
    ...
    @mock.patch('storage.image.image_utils.os.path')
    ...
    @mock.patch('storage.image.image_utils.temporary_dir')
    @mock.patch('storage.image.image_utils.os.rename')
    @mock.patch('storage.image.image_utils.fileutils.delete_if_exists')
    @mock.patch('storage.image.image_utils.coalesce_chain')
    @mock.patch('storage.image.image_utils.fix_vhd_chain')
    @mock.patch('storage.image.image_utils.discover_vhd_chain')
    @mock.patch('storage.image.image_utils.extract_targz')
...
class TestCreateTemporaryFile(test.TestCase):
    @mock.patch('storage.image.image_utils.os.close')
    @mock.patch('storage.image.image_utils.CONF')
    @mock.patch('storage.image.image_utils.os.path.exists')
    @mock.patch('storage.image.image_utils.os.makedirs')
    @mock.patch('storage.image.image_utils.tempfile.mkstemp')
    ...
    @mock.patch('storage.image.image_utils.os.close')
    @mock.patch('storage.image.image_utils.CONF')
    @mock.patch('storage.image.image_utils.os.path.exists', return_value=True)
    @mock.patch('storage.image.image_utils.os.makedirs')
    @mock.patch('storage.image.image_utils.tempfile.mkstemp')
    ...
    @mock.patch('storage.image.image_utils.os.close')
    @mock.patch('storage.image.image_utils.CONF')
    @mock.patch('storage.image.image_utils.os.path.exists', return_value=False)
    @mock.patch('storage.image.image_utils.os.makedirs')
    @mock.patch('storage.image.image_utils.tempfile.mkstemp')
...
class TestTemporaryFileContextManager(test.TestCase):
    @mock.patch('storage.image.image_utils.create_temporary_file',

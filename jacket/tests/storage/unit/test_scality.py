...
import jacket.storage.volume.drivers.scality as driver
...
_FAKE_VOLUME_DIR = 'storage/volumes'
...
class ScalityDriverTestCase(test.TestCase):
    ...
    @mock.patch("storage.volume.utils.read_proc_mounts")
    ...
    def test_initialize_connection(self, mock_qemu_img_info):
        ...
        expected_conn_info = {
            ...
            'data': {
                ...
                'sofs_path': 'storage/volumes/00/' + _FAKE_VOLUME['name'],
                'format': 'raw'
            }
        }

...
from jacket.storage.volume.flows.manager import create_volume as create_volume_manager
...
class CreateVolumeFlowTestCase(test.TestCase):
    ...
    @mock.patch('storage.volume.utils.extract_host')
    @mock.patch('time.time')
    @mock.patch('storage.objects.ConsistencyGroup.get_by_id')
    ...
    @mock.patch('storage.volume.volume_types.is_encrypted')
    @mock.patch('storage.volume.flows.api.create_volume.'
    ...
    @mock.patch('storage.volume.volume_types.is_encrypted')
    @mock.patch('storage.volume.volume_types.get_volume_type_qos_specs')
    @mock.patch('storage.volume.flows.api.create_volume.'
                'ExtractVolumeRequestTask.'
                '_get_volume_type_id')
    ...
    @mock.patch('storage.volume.volume_types.is_encrypted')
    @mock.patch('storage.volume.volume_types.get_volume_type_qos_specs')
    @mock.patch('storage.volume.volume_types.get_default_volume_type')
    @mock.patch('storage.volume.volume_types.get_volume_type_by_name')
    @mock.patch('storage.volume.flows.api.create_volume.'
                'ExtractVolumeRequestTask.'
                '_get_volume_type_id')
    ...
    @mock.patch('storage.db.volume_type_get_by_name')
    @mock.patch('storage.volume.volume_types.is_encrypted')
    @mock.patch('storage.volume.volume_types.get_volume_type_qos_specs')
    @mock.patch('storage.volume.volume_types.get_default_volume_type')
    @mock.patch('storage.volume.flows.api.create_volume.'
...
class CreateVolumeFlowManagerTestCase(test.TestCase):
    ...
    @mock.patch('storage.volume.flows.manager.create_volume.'
                'CreateVolumeFromSpecTask.'
                '_handle_bootable_volume_glance_meta')
    @mock.patch('storage.objects.Volume.get_by_id')
    @mock.patch('storage.objects.Snapshot.get_by_id')
...
class CreateVolumeFlowManagerGlanceCinderBackendCase(test.TestCase):
    ...
    def test_create_from_image_volume(self, handle_bootable, mock_fetch_img,
                                      ...
                                      location=True):
        self.flags(allowed_direct_url_schemes=['storage'])
...
@mock.patch('storage.context.get_internal_tenant_context')

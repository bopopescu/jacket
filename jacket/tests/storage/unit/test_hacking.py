...
from jacket.storage.hacking import checks
from jacket.storage import test


@ddt.ddt
class HackingTestCase(test.TestCase):
    """This class tests the hacking checks in storage.hacking.checks
    ...
    def test_check_explicit_underscore_import(self):
        ...
        self.assertEqual(0, len(list(checks.check_explicit_underscore_import(
            ...
            "storage.tests.unit/other_files.py"))))
        self.assertEqual(0, len(list(checks.check_explicit_underscore_import(
            "from storage.i18n import _LE, _, _LW",
            "storage.tests.unit/other_files2.py"))))
        self.assertEqual(0, len(list(checks.check_explicit_underscore_import(
            "msg = _('My message')",
            "storage.tests.unit/other_files2.py"))))
        self.assertEqual(0, len(list(checks.check_explicit_underscore_import(
            "_ = translations.ugettext",
            "storage.tests.unit/other_files3.py"))))
        self.assertEqual(0, len(list(checks.check_explicit_underscore_import(
            "msg = _('My message')",
            "storage.tests.unit/other_files3.py"))))
        ...
        self.assertEqual(0, len(list(checks.check_explicit_underscore_import(
            ...
            "storage.tests.unit/other_files4.py"))))
        self.assertEqual(0, len(list(checks.check_explicit_underscore_import(
            "from storage.i18n import _LW",
            "storage.tests.unit/other_files5.py"))))
        self.assertEqual(1, len(list(checks.check_explicit_underscore_import(
            "msg = _('My message')",
            "storage.tests.unit/other_files5.py"))))
    ...
    def test_validate_log_translations(self):
        ...
        self.assertEqual(0, len(list(checks.validate_log_translations(
            "LOG.info('foo')", "storage/tests/foo.py"))))
        self.assertEqual(0, len(list(checks.validate_log_translations(
    ...
    def test_no_print_statements(self):
        self.assertEqual(0, len(list(checks.check_no_print_statements(
            ...
            "storage/file.py", False))))
        self.assertEqual(1, len(list(checks.check_no_print_statements(
            "print('My print statement')",
            "storage/file.py", False))))
        self.assertEqual(0, len(list(checks.check_no_print_statements(
            "print('My print statement in storage/cmd, which is ok.')",
            "storage/cmd/file.py", False))))
        self.assertEqual(0, len(list(checks.check_no_print_statements(
            "print('My print statement that I just must have.')",
            "storage.tests.unit/file.py", True))))
        self.assertEqual(1, len(list(checks.check_no_print_statements(
            "print ('My print with space')",
            "storage/volume/anotherFile.py", False))))
    ...
    @ddt.unpack
    @ddt.data(
        (1, 'LOG.info', "storage/tests/unit/fake.py", False),
        (1, 'LOG.warning', "storage/tests/fake.py", False),
        (1, 'LOG.error', "storage/tests/fake.py", False),
        (1, 'LOG.exception', "storage/tests/fake.py", False),
        (1, 'LOG.debug', "storage/tests/fake.py", False),
        (0, 'LOG.info.assert_called_once_with', "storage/tests/fake.py", False),
        (0, 'some.LOG.error.call', "storage/tests/fake.py", False),
        (0, 'LOG.warning', "storage/tests/unit/fake.py", True),
        (0, 'LOG.warning', "storage/tests/unit/integrated/fake.py", False))

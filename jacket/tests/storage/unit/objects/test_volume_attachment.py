...
class TestVolumeAttachment(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('storage.db.sqlalchemy.api.volume_attachment_get')
    def test_get_by_id(self, volume_attachment_get):
        ...
        attachment = storage.VolumeAttachment.get_by_id(self.context,
                                                        fake.attachment_id)
        self._compare(self, db_attachment, attachment)

    @mock.patch('storage.db.volume_attachment_update')

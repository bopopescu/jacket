...
from jacket.tests.storage.unit import fake_hpe_lefthand_client as hpelefthandclient
from jacket.storage.volume.drivers.hpe import hpe_lefthand_iscsi
...
class TestHPELeftHandISCSIDriver(HPELeftHandBaseDriver, test.TestCase):
    ...
    def test_create_volume(self):
        ...
        with mock.patch.object(hpe_lefthand_iscsi.HPELeftHandISCSIDriver,
            ...
            # ensure the raised exception is a storage exception

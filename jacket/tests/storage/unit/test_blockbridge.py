...
import jacket.storage.volume.drivers.blockbridge as bb
...
class BlockbridgeISCSIDriverTestCase(test.TestCase):
    ...
    def test_cfg_api_auth_scheme_password(self):
        ...
        headers = {
            ...
            'User-Agent': "storage-volume/%s" % self.driver.VERSION,
        }
        ...
        self.assertTrue(conn_url.startswith("/api/storage/status?"),
                        repr(conn_url))
    ...
    @common_mocks
    @mock.patch('storage.volume.utils.generate_username')

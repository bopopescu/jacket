...
from jacket.storage.volume import driver as base_driver
from jacket.storage.volume.drivers import glusterfs
from jacket.storage.volume.drivers import remotefs as remotefs_drv
...
class GlusterFsDriverTestCase(test.TestCase):
    ...
    TEST_SHARES_CONFIG_FILE = '/etc/storage/test-shares.conf'
    ...
    def _simple_volume(self, id=None):
        ...
        if id is None:
            ...
            volume['id'] = id
        # volume['name'] mirrors format from storage/sqlalchemy/models.py
    ...
    def test_create_snapshot_online(self):
        ...
        with mock.patch.object(drv, '_do_create_snapshot') as \
                ...
                mock.patch.object(storage, 'snapshot_get') as mock_snapshot_get,\
    ...
    def test_delete_snapshot_online_2(self):
        ...
        with mock.patch.object(drv, '_execute') as mock_execute,\
                mock.patch.object(storage, 'snapshot_get') as \
                mock_snapshot_get,\

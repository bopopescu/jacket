...
from jacket.storage import test  # For the flags
from jacket.tests.storage.functional.api import client
...
class _FunctionalTestBase(test.TestCase):
    ...
    def _get_flags(self):
        ...
        # separately
        f['scheduler_driver'] = ('storage.scheduler.filter_scheduler.FilterSche'
                                 'duler')

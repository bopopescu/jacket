...
class Architecture(Enum):
    # TODO(berrange): move all constants out of 'jacket.compute.compute.arch'
...
class CPUMode(Enum):
    # TODO(berrange): move all constants out of 'jacket.compute.compute.cpumodel'
    # into fields on this class
    def __init__(self, **kwargs):
...
class HVType(Enum):
    # TODO(berrange): move all constants out of 'jacket.compute.compute.hv_type'
    # into fields on this class
    def __init__(self):
...
class VMMode(Enum):
    # TODO(berrange): move all constants out of 'jacket.compute.compute.vm_mode'
    # into fields on this class
    def __init__(self):
...
class HostStatus(Enum):
    ...
    UP = "UP"  # The compute-compute is up.
    DOWN = "DOWN"  # The compute-compute is forced_down.
    MAINTENANCE = "MAINTENANCE"  # The compute-compute is disabled.
    UNKNOWN = "UNKNOWN"  # The compute-compute has not reported.
    NONE = ""  # No host or compute-compute.

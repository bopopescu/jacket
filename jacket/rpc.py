...
# NOTE(markmc): The compute.openstack.common.rpc entries are for backwards compat
...
class LegacyValidatingNotifier(object):
    ...
    def _is_wrap_exception_notification(self, payload):
        # jacket.compute.wrap_exception decorator emits notification where the

...
core_opts = [
    cfg.StrOpt('state_path',
               ...
               help="Top-level directory for maintaining storage's state"), ]
...
global_opts = [
    ...
    cfg.MultiStrOpt('osapi_volume_extension',
                    default=['storage.api.storage.contrib.standard_extensions'],
                    help='osapi volume extension to load'),
    cfg.StrOpt('volume_manager',
               default='storage.volume.manager.VolumeManager',
               help='Full class name for the Manager for volume'),
    cfg.StrOpt('backup_manager',
               default='storage.backup.manager.BackupManager',
               help='Full class name for the Manager for volume backup'),
    cfg.StrOpt('scheduler_manager',
               default='storage.scheduler.manager.SchedulerManager',
    ...
    cfg.StrOpt('rootwrap_config',
               default='/etc/storage/rootwrap.conf',
    ...
    cfg.StrOpt('volume_api_class',
               default='storage.volume.api.API',
               help='The full class name of the volume API class to use'),
    cfg.StrOpt('backup_api_class',
               default='storage.backup.api.API',

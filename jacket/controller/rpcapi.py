...
rpcapi_opts = [
    cfg.StrOpt('jacket_controller_topic',
               default='jacket-controller',
               help='The topic manager nodes listen on'),
]
...
class ManagerAPI(object):
    ...
    def __init__(self):
        ...
        target = messaging.Target(topic=CONF.jacket_manager_topic, version='1.0')

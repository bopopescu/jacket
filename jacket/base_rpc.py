...
# NOTE(flaper87): The jacket.openstack.common.rpc entries are
# for backwards compat with Havana rpc_backend configuration
# values. The jacket.rpc entries are for compat with Folsom values.
TRANSPORT_ALIASES = {
    'jacket.openstack.common.rpc.impl_kombu': 'rabbit',
    'jacket.openstack.common.rpc.impl_qpid': 'qpid',
    'jacket.openstack.common.rpc.impl_zmq': 'zmq',
    'jacket.rpc.impl_kombu': 'rabbit',
    'jacket.rpc.impl_qpid': 'qpid',
    'jacket.rpc.impl_zmq': 'zmq',
}
...
class RPCAPI(object):
    ...
    def __init__(self):
        ...
        serializer = base.JacketObjectSerializer(obj_version_cap)
    ...
    def determine_rpc_version_cap(cls):
        ...
        version_cap = objects.Service.get_minimum_rpc_version(
            jacket.context.get_admin_context(), cls.BINARY)

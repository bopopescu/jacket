...
"""
SQLAlchemy models for storage data.
"""
...
class Service(BASE, CinderBase):
    ...
    availability_zone = Column(String(255), default='storage')
    disabled_reason = Column(String(255))
    # adding column modified_at to contain timestamp
    # for manual enable/disable of storage services
...
def register_models():
    ...
    Called from storage.db.sqlalchemy.__init__ as part of loading the driver,

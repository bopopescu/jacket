...
def validate_policy(context, action):
    try:
        jacket.policy.enforce_action(context, action)
        return True
...
def get_sort_params(params, default_key='created_at', default_dir='desc'):
    ...
    :param params: webob.multidict of request parameters (from
                   jacket.api.openstack.wsgi.Request.params)
...
def remove_version_from_href(href):
    ...
    Given: 'http://jacket.example.com/v1.1/123'
    Returns: 'http://jacket.example.com/123'

    Given: 'http://jacket.example.com/v1.1'
    Returns: 'http://jacket.example.com'

    Given: 'http://jacket.example.com/volume/drivers/v1.1/flashsystem'
    Returns: 'http://jacket.example.com/volume/drivers/flashsystem'
...
class ViewBuilder(object):
    ...
    def _get_next_link(self, request, identifier, collection_name):
        ...
        url = os.path.join(prefix,
                           request.environ["jacket.context"].project_id,
                           collection_name)

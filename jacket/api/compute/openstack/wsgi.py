...
from jacket.api.compute.openstack import versioned_method
...
class Request(wsgi.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'compute.best_content_type' not in self.environ:
            ...
            self.environ['compute.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['compute.best_content_type']
        ...
        for ext in extensions:
            ...
            if inspect.isgenerator(ext):
                ...
                try:
                    ...
                    # If an attached extension (@compute.extends) for the
...
class ControllerMetaclass(type):
    ...
    def __new__(mcs, name, bases, cls_dict):
        ...
        # start with compute actions from base classes
        for base in bases:
        ...
        def version_select(*args, **kwargs):
            ...
            for func in func_list:
                if ver.matches(func.start_version, func.end_version):
                    ...
                    # other decorator attributes like compute.response
                    # are still respected.

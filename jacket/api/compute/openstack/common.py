...
def remove_trailing_version_from_href(href):
    ...
    Given: 'http://www.compute.com/compute/v1.1'
    Returns: 'http://www.compute.com/compute'

    Given: 'http://www.compute.com/v1.1'
    Returns: 'http://www.compute.com'
...
class ViewBuilder(object):
    ...
    def _get_project_id(self, request):
        ...
        otherwise
        """
        project_id = request.environ["compute.context"].project_id

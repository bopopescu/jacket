...
from jacket.api.compute.openstack.compute.legacy_v2 import consoles as v2_consoles
from jacket.api.compute.openstack.compute.legacy_v2 import extensions as v2_extensions
from jacket.api.compute.openstack.compute.legacy_v2 import flavors as v2_flavors
from jacket.api.compute.openstack.compute.legacy_v2 import image_metadata \
        as v2_image_metadata
from jacket.api.compute.openstack.compute.legacy_v2 import images as v2_images
from jacket.api.compute.openstack.compute.legacy_v2 import ips as v2_ips
from jacket.api.compute.openstack.compute.legacy_v2 import limits as v2_limits
from jacket.api.compute.openstack.compute.legacy_v2 import server_metadata \
        as v2_server_metadata
from jacket.api.compute.openstack.compute.legacy_v2 import servers as v2_servers
from jacket.api.compute.openstack.compute.legacy_v2 import versions \
...
class APIRouter(jacket.api.compute.openstack.APIRouter):
...
class APIRouterV21(jacket.api.compute.openstack.APIRouterV21):
    """Routes requests on the OpenStack API to the appropriate controller
    and method.
    """

...
from jacket.api.compute.openstack.compute.views import flavors as views_flavors
from jacket.api.compute.openstack.compute.views import images as views_images
...
class ViewBuilderV21(ViewBuilder):
    ...
    def __init__(self):
        ...
        # use glance endpoint. We revert back it to use compute endpoint for v2.1.
        self._image_builder = views_images.ViewBuilder()

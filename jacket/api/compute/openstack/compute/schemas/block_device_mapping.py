...
from jacket.api.compute.openstack.compute.schemas import block_device_mapping_v1
...
block_device_mapping_new_item = {
    # defined in compute/block_device.py:from_api()
    ...
    # Defined as integer in compute/block_device.py:from_api()
    'boot_index': {
        'type': ['integer', 'string'],
        'pattern': '^-?[0-9]+$',
    },

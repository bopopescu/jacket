...
class InjectContext(compute.Middleware):
    """Add a 'compute.context' to WSGI environ."""

    def __init__(self, context, *args, **kwargs):
        self.context = context
        super(InjectContext, self).__init__(*args, **kwargs)

    @webob.dec.wsgify(RequestClass=compute.Request)
    def __call__(self, req):
        req.environ['compute.context'] = self.context
        return self.application


class NovaKeystoneContext(compute.Middleware):

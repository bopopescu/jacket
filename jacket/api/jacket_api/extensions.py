...
class ExtensionManager(object):
    ...
    See jacket/tests/api/extensions/foxinsocks/extension.py for an
    ...
    def __init__(self):
        ...
        self.cls_list = CONF.osapi_jacket_extension
        self.extensions = {}
...
class ControllerExtension(object):
    """Extend core controllers of jacket OpenStack API.

    Provide a way to extend existing jacket OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in jacket."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        jacket.policy.enforce(context, act, target)
    return authorize

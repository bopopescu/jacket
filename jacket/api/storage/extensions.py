...
class ExtensionManager(object):
    ...
    See storage/tests/api/extensions/foxinsocks/extension.py for an
...
class ControllerExtension(object):
    """Extend core controllers of storage OpenStack API.

    Provide a way to extend existing storage OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in storage."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        jacket.storage.policy.enforce(context, act, target)
    return authorize

...
from jacket.api.storage.views import limits as limits_views
from jacket.api.storage import xmlutil
from jacket.storage.i18n import _
from jacket.storage import quota
from jacket.wsgi.storage import common as base_wsgi
...
class LimitsController(wsgi.Controller):
    ...
    def index(self, req):
        ...
        rate_limits = req.environ.get("storage.limits", [])
...
class RateLimitingMiddleware(base_wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        req.environ["storage.limits"] = self._limiter.get_limits(username)

...
from jacket.api.storage.openstack import api_version_request as api_version
from jacket.api.storage.openstack import versioned_method
from jacket.storage import exception
from jacket.storage import i18n
from jacket.storage.i18n import _, _LE, _LI
from jacket.storage import utils
from jacket.wsgi.storage import common as wsgi
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'storage.best_content_type' not in self.environ:
            ...
            self.environ['storage.best_content_type'] = (content_type or
                                                        'application/json')

        return self.environ['storage.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('storage.context')
...
def _set_request_id_header(req, headers):
    context = req.environ.get('storage.context')
    if context:

...
from jacket.common.storage import config  # noqa Need to register global_opts
from jacket.db.storage import migration
from jacket.db.storage.sqlalchemy import api as sqla_api
...
class TestCase(testtools.TestCase):
    ...
    def setUp(self):
        ...
        # and _determine_rpc_version_cap functions in storage.rpc.RPCAPI cache
        ...
        self.override_config('policy_file',
                             os.path.join(
                                 ...
                                 'storage/tests/unit/policy.json'),
                             group='oslo_policy')

        self._disable_osprofiler()

        # NOTE(geguileo): This is required because common get_by_id method in
        # storage.db.sqlalchemy.api caches get methods and if we use a mocked
    ...
    def start_service(self, name, host=None, **kwargs):
        ...
        kwargs.setdefault('binary', 'storage-%s' % name)

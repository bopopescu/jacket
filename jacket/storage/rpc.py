...
ALLOWED_EXMODS = [
    jacket.storage.exception.__name__,
]
EXTRA_EXMODS = []

# NOTE(flaper87): The storage.openstack.common.rpc entries are
...
class RequestContextSerializer(messaging.Serializer):
    ...
    def deserialize_context(self, context):
        ...
        return jacket.storage.context.RequestContext.from_dict(context)

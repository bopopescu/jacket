...
class API(base.Base):
    ...
    def create_from_src(self, context, name, description=None,
        ...
        if cgsnapshot_id:
            try:
                cgsnapshot = storage.CGSnapshot.get_by_id(context,
                                                          cgsnapshot_id)
        ...
        if source_cgid:
            try:
                source_cg = storage.ConsistencyGroup.get_by_id(context,
                                                               source_cgid)
    ...
    def get(self, context, group_id):
        group = storage.ConsistencyGroup.get_by_id(context, group_id)
    ...
    def get_all(self, context, filters=None, marker=None, limit=None,
        ...
        if (context.is_admin and 'all_tenants' in filters):
            ...
            groups = storage.ConsistencyGroupList.get_all(
                context, filters=filters, marker=marker, limit=limit,
                offset=offset, sort_keys=sort_keys, sort_dirs=sort_dirs)
        else:
            groups = storage.ConsistencyGroupList.get_all_by_project(
    ...
    def get_cgsnapshot(self, context, cgsnapshot_id):
        ...
        cgsnapshots = storage.CGSnapshot.get_by_id(context, cgsnapshot_id)
        return cgsnapshots
    ...
    def get_all_cgsnapshots(self, context, search_opts=None):
        ...
        if context.is_admin and 'all_tenants' in search_opts:
            ...
            cgsnapshots = storage.CGSnapshotList.get_all(context, search_opts)
        else:

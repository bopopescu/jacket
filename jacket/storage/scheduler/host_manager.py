...
class HostState(object):
    ...
    def __init__(self, host, capabilities=None, service=None):
        ...
        # capacity has been allocated in storage POV, which should be
...
class HostManager(object):
    ...
    def __init__(self):
        ...
        self.host_state_map = {}
        self.filter_handler = filters.HostFilterHandler('storage.scheduler.'
                                                        'filters')
        self.filter_classes = self.filter_handler.get_all_classes()
        self.weight_handler = weights.HostWeightHandler('storage.scheduler.'
                                                        'weights')

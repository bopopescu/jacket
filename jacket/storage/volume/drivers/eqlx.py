...
from jacket.storage.volume.drivers import san
...
eqlx_opts = [
    ...
    cfg.IntOpt('eqlx_cli_timeout',
               ...
               help='Timeout for the Group Manager cli command execution. '
                    ...
                    'specified in storage/volume/drivers/san/san.py '
    ...
    cfg.BoolOpt('eqlx_use_chap',
                ...
                help='Use CHAP authentication for targets. Note that this '
                     ...
                     'specified in storage/volume/driver.py and will be '
...
class DellEQLSanISCSIDriver(san.SanISCSIDriver):
    ...
    To enable the driver add the following line to the storage configuration:
        volume_driver=storage.volume.drivers.eqlx.DellEQLSanISCSIDriver

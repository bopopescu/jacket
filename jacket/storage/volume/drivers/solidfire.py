...
from jacket.storage.volume.targets import iscsi as iscsi_driver
...
sf_opts = [
    ...
    cfg.StrOpt('sf_account_prefix',
               help='Create SolidFire accounts with this prefix. Any string '
                    ...
                    'and will create a prefix using the storage node hostname '
    ...
    cfg.StrOpt('sf_volume_prefix',
               ...
               help='Create SolidFire volumes with this prefix. Volume names '
                    'are of the form <sf_volume_prefix><storage-volume-id>.  '
...
class SolidFireDriver(san.SanISCSIDriver):
    ...
    def create_volume(self, volume):
        ...
        determine account info based on passed in storage volume object.  First

...
from jacket.storage.volume.drivers.netapp.eseries import exception as eseries_exc
from jacket.storage.volume.drivers.netapp.eseries import host_mapper
from jacket.storage.volume.drivers.netapp.eseries import utils
from jacket.storage.volume.drivers.netapp import options as na_opts
...
class NetAppESeriesLibrary(object):
    ...
    SNAPSHOT_PERSISTENT_STORE_KEY = 'storage-snapshots'
    ...
    def _create_asup(self, cinder_host):
        ...
        # comprised of serial numbers and storage host with a default
    ...
    def delete_cgsnapshot(self, cgsnapshot, snapshots):
        ...
        if int(seq_num) <= int(min_seq_num):
            ...
            # Perform a soft-delete, removing this snapshot from storage

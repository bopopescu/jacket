    ...
    def delete_cgsnapshot(self, context, cgsnapshot, snapshots):
        ...
        for i, snapshot in enumerate(snapshots):
            ...
            try:
                ...
                # it helps clean up the storage entries.
                LOG.warning(_LW("Delete Snapshot id not found. Removing from "
                                "storage: %(id)s Ex: %(msg)s"),
    ...
    def delete_vlun(self, volume, hostname):
        ...
        for vlun in vluns:
            ...
            try:
                ...
                # because storage was not responsible for the host set
                # assignment.  The host set could be used outside of storage
    ...
    def get_volume_settings_from_type_id(self, type_id, pool):
        ...
        if cpg is not default_cpg:
            ...
            msg = _LW("'hpe3par:cpg' is not supported as an extra spec "
                      ...
                      "the storage scheduler, as a pool, from the "
                      "storage.conf entry 'hpe3par_cpg', which can "
                      "be a list of CPGs.")
...
class ModifySpecsTask(flow_utils.CinderTask):
    ...
    created VVS (when appropriate), delete the old storage-created VVS, call

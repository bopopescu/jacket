...
volume_driver=storage.volume.drivers.hpe.hpe_lefthand_iscsi.
...
class HPELeftHandISCSIDriver(driver.ISCSIDriver):
    ...
    def update_consistencygroup(self, context, group,
        ...
        Because the backend has no concept of volume grouping, storage will
        ...
        simply returning out of this function allows storage to properly
    ...
    def _do_volume_replication_setup(self, volume, client, optional=None):
        ...
        try:
            ...
            for remote_target in self._replication_targets:
                ...
                # not managed by storage. This snapshot will be removed when

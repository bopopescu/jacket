...
Set the following in the storage.conf file to enable the
3PAR iSCSI Driver along with the required flags:

volume_driver=storage.volume.drivers.hpe.hpe_3par_iscsi.HPE3PARISCSIDriver
"""
...
from jacket.storage.volume.drivers.san import san
    ...
    def initialize_connection(self, volume, connector):
        ...
        try:
            ...
            if connector.get('multipath'):
                ...
                # Target portal ips are defined in storage.conf.

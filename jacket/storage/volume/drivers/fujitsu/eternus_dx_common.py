...
FJ_ETERNUS_DX_OPT_opts = [
    cfg.StrOpt('cinder_eternus_config_file',
               default='/etc/storage/cinder_fujitsu_eternus_dx.xml',
               help='config file for storage eternus_dx volume driver'),
]
...
class FJDXCommon(object):
    ...
    @lockutils.synchronized('ETERNUS-vol', 'storage-', True)
    ...
    @lockutils.synchronized('ETERNUS-update', 'storage-', True)
    ...
    @lockutils.synchronized('ETERNUS-SMIS-exec', 'storage-', True)
    ...
    @lockutils.synchronized('ETERNUS-SMIS-other', 'storage-', True)
    ...
    @lockutils.synchronized('ETERNUS-SMIS-getinstance', 'storage-', True)
    ...
    @lockutils.synchronized('ETERNUS-connect', 'storage-', True)

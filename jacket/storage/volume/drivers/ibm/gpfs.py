...
class GPFSDriver(driver.ConsistencyGroupVD, driver.ExtendVD,
    ...
    def delete_snapshot(self, snapshot):
        ...
        # storage db. Attempt to delete the snapshot.  If the snapshot has
    ...
    def copy_image_to_volume(self, context, volume, image_service, image_id):
        ...
        Note that storage.volume.flows.create_volume will attempt to use
...
class GPFSNFSDriver(GPFSDriver, nfs.NfsDriver, san.SanDriver):
    """GPFS storage driver extension.

    This extends the capability of existing GPFS storage driver
    to be able to create storage volumes when storage volume service

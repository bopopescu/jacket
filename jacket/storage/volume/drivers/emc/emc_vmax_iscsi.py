...
CINDER_CONF = '/etc/storage/storage.conf'
...
class EMCVMAXISCSIDriver(driver.ISCSIDriver):
    ...
    Version history:
        ...
        2.3.0 - Name change for MV and SG for FAST (bug #1515181)
              ...
              https://blueprints.launchpad.net/storage/+spec/vmax3-extend-volume
    ...
    def _check_for_iscsi_ip_address(self):
        """Check to see if iscsi_ip_address is set in storage.conf

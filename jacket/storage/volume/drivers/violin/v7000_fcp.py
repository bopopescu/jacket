...
Set the following in the storage.conf file to enable the VMEM V7000
Fibre Channel Driver along with the required flags:

volume_driver=storage.volume.drivers.violin.v7000_fcp.V7000FCDriver
...
class V7000FCPDriver(driver.FibreChannelDriver):
    ...
    def ensure_export(self, context, volume):
        """Synchronously checks and re-exports volumes at storage start time."""
        pass

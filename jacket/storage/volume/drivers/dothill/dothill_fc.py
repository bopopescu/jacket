...
from jacket.storage.volume.drivers.dothill import dothill_common
...
class DotHillFCDriver(jacket.storage.volume.driver.FibreChannelDriver):
    """OpenStack Fibre Channel storage drivers for DotHill Arrays.

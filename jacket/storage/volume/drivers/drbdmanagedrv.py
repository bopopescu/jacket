...
from jacket.storage.i18n import _, _LW, _LI, _LE
...
AUX_PROP_CINDER_VOL_ID = "storage-id"
AUX_PROP_TEMP_CLIENT = "storage-is-temp-client"
...
class DrbdManageBaseDriver(driver.VolumeDriver):
    ...
    def _update_volume_stats(self):
        ...
        # This has to match the name set in the storage volume driver spec,

...
from jacket.storage import utils as cutils
from jacket.storage.volume.drivers.hitachi import hnas_backend
...
NFS_OPTS = [
    cfg.StrOpt('hds_hnas_nfs_config_file',
               ...
               help='Configuration file for HDS NFS storage plugin'), ]
...
class HDSNFSDriver(nfs.NfsDriver):
    ...
    def manage_existing(self, volume, existing_vol_ref):
        ...
        :param volume:           storage volume to manage
    ...
    def _check_pool_and_share(self, volume, nfs_share):
        ...
        :param volume:    storage volume reference
    ...
    def unmanage(self, volume):
        ...
        :param volume: storage volume to unmanage
        """

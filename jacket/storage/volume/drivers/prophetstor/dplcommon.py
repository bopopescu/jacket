...
from jacket.storage.volume.drivers.prophetstor import options
...
class DPLCOMMONDriver(driver.ConsistencyGroupVD, driver.ExtendVD,
    ...
    def _get_pools(self):
        pools = []
        qpools = []
        # Defined access pool by storage configuration.
    ...
    def do_setup(self, context):
        ...
        LOG.info(_LI('Activate Flexvisor storage volume driver.'))

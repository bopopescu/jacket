...
class Service(service.Service):
    ...
    def __init__(self, host, binary, topic, manager, report_interval=None,
        ...
        try:
            service_ref = storage.Service.get_by_args(ctxt, host, binary)
    ...
    def _create_service_ref(self, context, rpc_version=None):
        ...
        service_ref = storage.Service(context=context, **kwargs)
        service_ref.create()
        self.service_id = service_ref.id
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'storage-' part
        ...
        if not topic:
            topic = binary
        if not manager:
            subtopic = topic.rpartition('storage-')[2]
    ...
    def report_state(self):
        ...
        try:
            try:
                service_ref = storage.Service.get_by_id(ctxt, self.service_id)
            except exception.NotFound:

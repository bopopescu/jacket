...
CONF = cfg.CONF
CONF.import_opt('encryption_auth_url', jacket.storage.keymgr.key_mgr', group='keymgr')
CONF.import_opt('encryption_api_url', 'jacket.storage.keymgr.key_mgr', group='keymgr')

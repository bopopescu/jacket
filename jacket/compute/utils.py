...
workarounds_opts = [
    cfg.BoolOpt('disable_rootwrap',
                ...
                help='This option allows a fallback to sudo for performance '
                     ...
                     'https://bugs.launchpad.net/compute/+bug/1415106'),
    cfg.BoolOpt('disable_libvirt_livesnapshot',
                ...
                help='When using libvirt 1.2.2 live snapshots fail '
                     ...
                     'resolved.  See '
                     'https://bugs.launchpad.net/compute/+bug/1334398'),
...
def monkey_patch():
    ...
    Example:
    'compute.api.ec2.cloud:compute.notifications.notify_decorator'

    Parameters of the decorator is as follows.
    (See compute.notifications.notify_decorator)
...
def sanitize_hostname(hostname, default_name=None):
    """Return a hostname which conforms to RFC-952 and RFC-1123 specs except
       ...
       Due to compute-network will leverage dnsmasq to set hostname, so we chose
       63.
...
def generate_mac_address():
    ...
    #             properly: 0xfa.
    #             Discussion: https://bugs.launchpad.net/compute/+bug/921838
    mac = [0xfa, 0x16, 0x3e,
...
def is_neutron():
    ...
    # class is.
    _IS_NEUTRON = (jacket.compute.network.is_neutron() is True)
    return _IS_NEUTRON

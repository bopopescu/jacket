...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = compute.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import compute.api.fancy_api
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = compute.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import compute.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `compute.exception.PasteAppNotFound`

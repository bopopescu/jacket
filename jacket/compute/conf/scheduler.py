...
use_bm_filters_opt = cfg.BoolOpt("scheduler_use_baremetal_filters",
        default=False,
        help="""
Set this to True to tell the compute scheduler that it should use the filters
...
namespace 'compute.scheduler.host_manager' of file 'setup.cfg'. For example,
...
of the entrypoints under the namespace 'compute.scheduler.driver' of file
...
If this is larger than the compute-service 'service_down_time' setting, Nova may
...
* Related options:
    ...
    ``compute-service service_down_time``
""")
...
* Services that use this:
    ...
    ``compute-compute, compute-conductor``

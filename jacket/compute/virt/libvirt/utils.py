...
from jacket.compute.virt import volumeutils
...
def chown_for_id_maps(path, id_maps):
    ...
    execute('compute-idmapshift', '-i', '-u', uid_maps_str,
...
def get_arch(image_meta):
    ...
    and it will fallback to the compute-compute (host) arch if no architecture

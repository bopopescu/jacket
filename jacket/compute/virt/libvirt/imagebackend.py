...
__imagebackend_opts = [
    ...
    cfg.StrOpt('hw_disk_discard',
               ...
               help='Discard option for compute managed disks. Need'
...
CONF.import_opt('key_size', 'compute.compute.api',
                group='ephemeral_storage_encryption')
CONF.import_opt('rbd_user', 'compute.virt.libvirt.volume.net', group='libvirt')
CONF.import_opt('rbd_secret_uuid', 'compute.virt.libvirt.volume.net',
                group='libvirt')
...
class Image(object):
    ...
    def verify_base_size(self, base, size, base_size=0):
        ...
        #  compute effectively ignore that size and use the size of the
    ...
    def resolve_driver_format(self):
        ...
        See https://bugs.launchpad.net/compute/+bug/1221190
        """
    ...
    def get_model(self, connection):
        ...
        :returns: an instance of compute.virt.image.model.Image
        """
        raise NotImplementedError()

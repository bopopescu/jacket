...
from jacket.compute.virt import diagnostics
from jacket.compute.virt.disk import api as disk
from jacket.compute.virt.disk.vfs import guestfs
...
from jacket.compute.virt.libvirt import firewall as libvirt_firewall
...
from jacket.compute.virt.libvirt import imagecache
from jacket.compute.virt.libvirt import instancejobtracker
...
from jacket.compute.virt.libvirt import vif as libvirt_vif
from jacket.compute.virt.libvirt.volume import remotefs
from jacket.compute.virt import netutils
from jacket.compute.virt import watchdog_actions
...
class LibvirtDriver(driver.ComputeDriver):
    ...
    # encapsulated by methods on the compute.virt.libvirt.host.Host
    ...
    def _destroy(self, instance, attempt=1):
        ...
        def _wait_for_destroy(expected_domid):
            ...
            # see https://bugs.launchpad.net/compute/+bug/1111213 for more details
    ...
    def _cleanup_resize(self, instance, network_info):
        ...
        #                be deleted correctly with grizzly or later compute.
    ...
    def snapshot(self, context, instance, image_id, update_task_state):
        ...
        try:
            ...
            # virDomain object to use compute.virt.libvirt.Guest.
    ...
    def _rebase_with_qemu_img(guest, device, active_disk_object,
        ...
        :type guest: compute.virt.libvirt.guest.Guest
        :param device: the guest block device to rebase
        :type device: compute.virt.libvirt.guest.BlockDevice
        :param active_disk_object: the guest block device to rebase
        :type active_disk_object: compute.virt.libvirt.config.\
    ...
    def _set_guest_for_inst_kernel(self, instance, guest, inst_path, virt_type,
        ...
        # kernel set and don't want to break compute if there's an
    ...
    def _get_guest_config(self, instance, network_info, image_meta,
        ...
        if root_device_name:
            # NOTE(yamahata):
            # for compute.api.ec2.cloud.CloudController.get_metadata()
    ...
    def get_available_resource(self, nodename):
        ...
        # See: https://bugs.launchpad.net/compute/+bug/1215593
    ...
    def _compare_cpu(self, guest_cpu, host_cpu_str):
        ...
        :param guest_cpu: compute.compute.VirtCPUModel or None
    ...
    def _live_migration_data_gb(self, instance, disk_paths):
        ...
        :param instance: the compute.compute.Instance being migrated
    ...
    def _disk_resize(self, image, size):
        ...
        :param image: an instance of compute.virt.image.model.Image

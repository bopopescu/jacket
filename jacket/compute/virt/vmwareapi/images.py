...
from jacket.compute.virt.vmwareapi import io_util
from jacket.compute.virt.vmwareapi import vm_util

# NOTE(mdbooth): We use use_linked_clone below, but don't have to import it
# because compute.virt.vmwareapi.driver is imported first. In fact, it is not
# possible to import it here, as compute.virt.vmwareapi.driver calls
...
class VMwareImage(object):
    ...
    def from_image(cls, image_id, image_meta):
        ...
        :rtype: compute.virt.vmwareapi.images.VmwareImage
        """

...
from jacket.compute.virt.xenapi.client import session
...
from jacket.compute.virt.xenapi import volumeops
...
class XenAPIDriver(driver.ComputeDriver):
    ...
    def get_all_bw_counters(self, instances):
        ...
        # we only care about VMs that correspond to a compute-managed
        # instance:
        ...
        for instance_name, counters in six.iteritems(all_counters):
            if instance_name in imap:
                # yes these are stats for a compute-managed vm
                # correlate the stats with the compute instance uuid:
    ...
    def check_can_live_migrate_destination(self, context, instance,
        ...
        :param instance: compute.db.sqlalchemy.models.Instance object

...
class ResourcePool(object):
    ...
    def add_to_aggregate(self, context, aggregate, host, slave_info=None):
        ...
        if len(aggregate.hosts) == 1:
            ...
            if master_compute == CONF.host and master_compute != host:
                ...
                # To this aim, compute compute on the slave has to go down.
                # NOTE: it is assumed that ONLY compute compute is running now
    ...
    def _eject_slave(self, aggregate_id, compute_uuid, host_uuid):
        ...
        try:
            # shutdown compute-compute; if there are other VMs running, e.g.

...
from jacket.compute.virt.disk.vfs import localfs as vfsimpl
...
from jacket.compute.virt.xenapi.image import utils as image_utils
...
def create_vbd(session, vm_ref, vdi_ref, userdevice, vbd_type='disk',
    ...
    if osvol:
        ...
        # attached compute (or cinder) volume

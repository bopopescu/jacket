...
from jacket.compute.virt.disk.mount import api as mount_api
from jacket.compute.virt.disk.vfs import api as vfs
...
class VFSLocalFS(vfs.VFS):
    ...
    uses the compute.virt.disk.mount.Mount API to make virtual disk
    ...
    def __init__(self, image, partition=None, imgdir=None):
        ...
        :param image: instance of compute.virt.image.model.Image

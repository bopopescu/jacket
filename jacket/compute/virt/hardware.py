...
def get_number_of_serial_ports(flavor, image_meta):
    ...
    :param image_meta: compute.compute.ImageMeta object instance
...
def _score_cpu_topology(topology, wanttopology):
    ...
    :param wanttopology: compute.compute.VirtCPUTopology instance for
                         preferred topology
...
def _get_cpu_topology_constraints(flavor, image_meta):
    ...
    This will return a pair of compute.compute.VirtCPUTopology instances,
...
def _get_possible_cpu_topologies(vcpus, maxtopology,
    ...
    :param maxtopology: compute.compute.VirtCPUTopology for upper limits
    ...
    list of compute.compute.VirtCPUTopology instances that represent every
    ...
    :returns: list of compute.compute.VirtCPUTopology instances
    """
...
def _filter_for_numa_threads(possible, wantthreads):
    ...
    :param possible: list of compute.compute.VirtCPUTopology
    ...
    :returns: list of compute.compute.VirtCPUTopology
    """
...
def _sort_possible_cpu_topologies(possible, wanttopology):
    ...
    :param possible: list of compute.compute.VirtCPUTopology instances
    :param wanttopology: compute.compute.VirtCPUTopology for preferred
                         topology
    ...
    :returns: sorted list of compute.compute.VirtCPUTopology instances
    """
...
def get_best_cpu_topology(flavor, image_meta, allow_threads=True,
    ...
    :returns: a compute.compute.VirtCPUTopology instance for best topology
    """
...
def _pack_instance_onto_cores(available_siblings,
    ...
    :param available_siblings: list of sets of CPU id's - available
                               siblings per core
    :param instance_cell: An instance of compute.InstanceNUMACell describing
                          the pinning requirements of the instance
    :param threads_per_core: number of threads per core in host's cell

    :returns: An instance of compute.InstanceNUMACell containing the pinning
...
def get_host_numa_usage_from_instance(host, instance, free=False,
    ...
    :param host: compute.compute.ComputeNode instance, or a db object or dict
    :param instance: compute.compute.Instance instance, or a db object or dict

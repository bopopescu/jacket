...
def get_block_device_info(instance, block_device_mapping):
    ...
    """
    from jacket.compute.virt import block_device as virt_block_device
...
class ComputeDriver(object):
    ...
    compute.virt layer, instances do not have human-readable names at all -- such
    ...
    Some methods here take an instance of compute.compute.service.Instance.  This
    is the data structure used by compute.compute to store details regarding an
    ...
    def rebuild(self, context, instance, image_meta, injected_files,
        ...
        :param instance: compute.objects.instance.Instance
                         This function should use the data there to guide
                         the creation of the new instance.
        :param compute.objects.ImageMeta image_meta:
            The metadata of the image of the instance.
        :param injected_files: User files to inject into instance.
        :param admin_password: Administrator password to set in instance.
        :param bdms: block-device-mappings to use for rebuild
        :param detach_block_devices: function to detach block devices. See
            compute.compute.manager.ComputeManager:_rebuild_default_impl for
            usage.
        :param attach_block_devices: function to attach block devices. See
            compute.compute.manager.ComputeManager:_rebuild_default_impl for
            usage.
        :param network_info:
           :py:meth:`~compute.network.manager.NetworkManager.get_instance_nw_info`
    ...
    def get_diagnostics(self, instance):
        ...
        :param compute.objects.instance.Instance instance:
    ...
    def get_instance_diagnostics(self, instance):
        ...
        :rtype: compute.virt.diagnostics.Diagnostics
        """
        raise NotImplementedError()
    ...
    def get_all_bw_counters(self, instances):
        ...
        :param instances: compute.objects.instance.InstanceList
        """
        raise NotImplementedError()
    ...
    def attach_interface(self, instance, image_meta, vif):
        ...
        :param compute.objects.ImageMeta image_meta:
            The metadata of the image of the instance.
        :param compute.network.model.NetworkInfo vif:
            The object which has the information about the interface to attach.

        :raise compute.exception.NovaException: If the attach fails.
    ...
    def detach_interface(self, instance, vif):
        ...
        :raise compute.exception.NovaException: If the detach fails.
    ...
    def migrate_disk_and_power_off(self, context, instance, dest,
        ...
        :param compute.objects.flavor.Flavor flavor:
            The flavor of the instance whose disk get migrated.
        :param compute.network.model.NetworkInfo network_info:
    ...
    def finish_migration(self, context, migration, instance, disk_info,
        ...
        :param instance: compute.objects.instance.Instance being migrated/resized
    ...
    def suspend(self, context, instance):
        ...
        :param compute.context.RequestContext context:
    ...
    def get_available_resource(self, nodename):
        ...
        This method is called when compute-compute launches, and
    ...
    def live_migration(self, context, instance, dest,
        ...
        :param context: security context
        :param instance:
            compute.db.sqlalchemy.models.Instance object
            instance object that is migrated.
        :param dest: destination host
        :param post_method:
            post operation method.
            expected compute.compute.manager._post_live_migration.
        :param recover_method:
            recovery method when any exception occurs.
            expected compute.compute.manager._rollback_live_migration.
    ...
    def check_can_live_migrate_destination(self, context, instance,
        ...
        :param context: security context
        :param instance: compute.db.sqlalchemy.models.Instance
    ...
    def get_instance_disk_info(self, instance,
        ...
        :param instance: compute.objects.Instance
    ...
    def ensure_filtering_rules_for_instance(self, instance, network_info):
        ...
        - setup_basic_filtering (for compute-basic, etc.)
        - prepare_instance_filter(for compute-instance-instance-xxx, etc.)
    ...
    def inject_file(self, instance, b64_path, b64_contents):
        ...
        The first parameter is an instance of compute.compute.service.Instance,
        ...
        can be removed from compute.compute.manager.
        """
        # TODO(Vek): Need to pass context in for access to auth_token
        raise NotImplementedError()
    ...
    def poll_rebooting_instances(self, timeout, instances):
        ...
        :param list instances:
            A list of compute.objects.instance.Instance objects that have been
    ...
    def manage_image_cache(self, context, all_instances):
        ...
        :param all_instances: compute.objects.instance.InstanceList
        """
        pass
    ...
    def add_to_aggregate(self, context, aggregate, host, **kwargs):
        ...
        :param compute.objects.aggregate.Aggregate aggregate:
    ...
    def get_per_instance_usage(self):
        ...
        :returns: dict of  compute uuid => dict of usage info
        """
        return {}
    ...
    def instance_on_disk(self, instance):
        ...
        :param instance: compute.objects.instance.Instance to lookup
    ...
    def register_event_listener(self, callback):
        ...
        an instance of the compute.virt.event.Event class.
        """
    ...
    def emit_event(self, event):
        ...
        if not isinstance(event, virtevent.Event):
            raise ValueError(
                _("Event must be an instance of compute.virt.event.Event"))
    ...
    def volume_snapshot_create(self, context, instance, volume_id,
        ...
        :param create_info: The data needed for compute to be able to attach
    ...
    def default_root_device_name(self, instance, image_meta, root_bdm):
        ...
        :param compute.objects.ImageMeta image_meta:
            The metadata of the image of the instance.
        :param compute.objects.BlockDeviceMapping root_bdm:
    ...
    def get_device_name_for_instance(self, instance,
        ...
        :param instance: compute.objects.instance.Instance that volume is
                         requesting a device name
        :param bdms: a compute.objects.BlockDeviceMappingList for the instance
        :param block_device_obj: A compute.objects.BlockDeviceMapping instance
    ...
    def quiesce(self, context, instance, image_meta):
        ...
        :param instance: compute.objects.instance.Instance to be quiesced
        :param compute.objects.ImageMeta image_meta:
            The metadata of the image of the instance.
        """
        raise NotImplementedError()
    ...
    def unquiesce(self, context, instance, image_meta):
        ...
        :param context:  request context
        :param instance: compute.objects.instance.Instance to be unquiesced
        :param compute.objects.ImageMeta image_meta:
            The metadata of the image of the instance.
        """
        raise NotImplementedError()
    ...
    def network_binding_host_id(self, context, instance):
        ...
        :param context:  request context
        :param instance: compute.objects.instance.Instance that the network
...
def load_compute_driver(virtapi, compute_driver=None):
    ...
    try:
        driver = importutils.import_object_ns('compute.virt',
                                              compute_driver,
                                              virtapi)

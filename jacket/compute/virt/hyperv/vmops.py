...
def get_network_driver():
    ...
    if jacket.compute.network.is_neutron() is None:
        # this is an unknown network type, not neutron or compute
        raise KeyError()
    elif jacket.compute.network.is_neutron():
...
class VMOps(object):
    ...
    def restart_vm_log_writers(self):
        # Restart the VM console log writers after compute compute restarts.

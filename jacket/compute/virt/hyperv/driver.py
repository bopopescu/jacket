...
from jacket.compute.virt.hyperv import eventhandler
from jacket.compute.virt.hyperv import hostops
from jacket.compute.virt.hyperv import livemigrationops
from jacket.compute.virt.hyperv import migrationops
from jacket.compute.virt.hyperv import rdpconsoleops
from jacket.compute.virt.hyperv import snapshotops
from jacket.compute.virt.hyperv import vmops
from jacket.compute.virt.hyperv import volumeops
...
class HyperVDriver(driver.ComputeDriver):
    ...
    def _check_minimum_windows_version(self):
        if not utilsfactory.get_hostutils().check_min_windows_version(6, 2):
            ...
            LOG.error(_LE('You are running compute-compute on an unsupported '

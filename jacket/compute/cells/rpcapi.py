...
"""
Client side of compute-cells RPC API (for talking to the compute-cells service
within a cell).

This is different than communication between child and parent compute-cells

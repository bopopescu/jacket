...
class ComputeAPI(object):
    ...
    API version history:
        ...
        * 2.45 - Made resize_instance() take new-world compute
        * 2.46 - Made finish_resize() take new-world compute
        * 2.47 - Made finish_revert_resize() take new-world compute
        ...
        * 3.6 - Make volume_snapshot_{create,delete} use new-world compute
        ...
        * 3.16 - Make reserve_block_device_name and attach_volume use new-world
                 compute, and add disk_bus and device_type params to
        ...
        * 3.21 - Made rebuild take new-world BDM compute
        * 3.22 - Made terminate_instance take new-world BDM compute

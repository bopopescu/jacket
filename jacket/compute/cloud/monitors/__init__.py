...
compute_monitors_opts = [
    ...
    cfg.ListOpt('compute_monitors',
                ...
                help='A list of monitors that can be used for getting '
                     ...
                     'the setuptools entry points for compute.compute.monitors.* '
...
class MonitorHandler(object):
    ...
    NAMESPACES = [
        'jacket.compute.compute.monitors.cpu',
    ]
    ...
    def check_enabled_monitor(self, ext):
        ...
        # 'jacket.compute.compute.monitors.cpu.virt_driver:Monitor'
        ...
        # NOTE(jaypipes): Append 'jacket.compute.compute.monitors.' to any monitor value
        # that doesn't have it to allow CONF.compute_monitors to use shortened
        # namespaces (like 'cpu.' instead of 'jacket.compute.compute.monitors.cpu.')
        cfg_monitors = ['jacket.compute.compute.monitors.' + cfg
                        if 'jacket.compute.compute.monitors.' not in cfg else cfg

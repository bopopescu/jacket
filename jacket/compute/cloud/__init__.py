...
# collisions with use of 'from compute.compute import <foo>' elsewhere.
import jacket.compute.cells.opts
import jacket.compute.exception


CELL_TYPE_TO_CLS_NAME = {'api': 'jacket.compute.compute.cells_api.ComputeCellsAPI',
                         'compute': 'jacket.compute.compute.api.API',
                         None: 'jacket.compute.compute.api.API',
                        }


def _get_compute_api_class_name():
    """Returns the name of compute API class."""
    cell_type = jacket.compute.cells.opts.get_cell_type()

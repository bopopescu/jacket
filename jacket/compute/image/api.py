...
class API(object):
    ...
    attempts to match the compute.volume.api and compute.network.api calling
    interface.
    """
    ...
    def _get_session_and_image_id(self, context, id_or_uri):
        ...
        :param context: The `compute.context.Context` object for the request
    ...
    def _get_session(self, _context):
        ...
        :param _context: The `compute.context.Context` object for the request
        """
    ...
    def download(self, context, id_or_uri, data=None, dest_path=None):
        ...
        :param context: The `compute.context.RequestContext` object for the
                        request
        :param id_or_uri: A UUID identifier or an image URI to look up image
                          information for.
        ...
        compute.image.download modules are used to attempt to do an SCP copy of
        ...
        Hyper-V virt drivers through compute.virt.images.fetch).

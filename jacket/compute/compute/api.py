...
from jacket.objects.compute import security_group as security_group_obj
from jacket.compute.pci import request as pci_request
import jacket.compute.policy
...
def check_policy(context, action, target, scope='compute'):
    ...
    jacket.compute.policy.enforce(context, _action, target)
...
class API(base.Base):
    ...
    def _handle_kernel_and_ramdisk(self, context, kernel_id, ramdisk_id,
        ...
        if kernel_id is not None:
            ...
            # Image object and hide all of that stuff within compute.image.api.
    ...
    def _local_delete(self, context, instance, bdms, delete_type, cb):
        ...
        elevated = context.elevated()
        if self.cell_type != 'api':
            # NOTE(liusheng): In compute-network multi_host scenario,deleting
    ...
    def backup(self, context, instance, name, backup_type, rotation,
        ...
        # to the backup_instance() method in compute/cells/messaging.py
    ...
    def snapshot(self, context, instance, name, extra_properties=None):
        ...
        # NOTE(comstud): Any changes to this method should also be made
        # to the snapshot_instance() method in compute/cells/messaging.py
...
class SecurityGroupAPI(base.Base, security_group_base.SecurityGroupBase):
    ...
    # The compute security group api does not use a uuid for the id.
    id_is_uuid = False

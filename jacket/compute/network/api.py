...
class API(base_api.NetworkAPI):
    """API for doing networking via the compute-network network manager.
    ...
    def get_all(self, context):
        ...
        networks. If it is a normal user and compute Flat or FlatDHCP
    ...
    def create_public_dns_domain(self, context, domain, project=None):
        """Create a public DNS domain with optional compute project."""
